...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      ...
      dist: {
        src: ['src/fjs/providers/*.js',
            'src/fjs/FDPProviderFactory.js',
            'src/fjs/Api.js'
        ],
    ...
    },'string-replace':
    {
      dist: {
        files: {
          'dist/amd/<%= pkg.name %>.debug.js':'src/fjsapi.js'
        },
        options: {
          replacements: [
            {
    ...
    'closure-compiler': {
      global: {
        ...
        js: 'dist/fjs.api.debug.js',
        jsOutputFile: 'dist/fjs.api.min.js',
        maxBuffer: 500,
        options: {
    ...
    shell: {
      clear: {
        command: 'bower cache clean FJSAPI'
      },
      install: {

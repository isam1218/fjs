 ...
 * User's addressbook. Store external contacts without jid. If user update addressbook and set jid, contact moves to xmpp_contact table.
 * @constructor
 */
fjs.fdp.AddressbookEntryModelBase = function()
{

...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
        ...
        src: [ 'src/fjs/fdp/model/_namespace.js'
      ...
      ,'string-replace':
      {
          dist: {
              files: {
                  'dist/amd/<%= pkg.name %>.debug.js':'src/fjsfdp.js'
              },
              options: {
                  replacements: [
                      {
    ...
    'closure-compiler': {
      global: {
        ...
        js: 'dist/fjs.fdp.debug.js',
        jsOutputFile: 'dist/fjs.fdp.min.js',
        maxBuffer: 500,
        options: {
    ...
    shell: {
      clear: {
        command: 'bower cache clean FJSFDP'
      },
      install: {

...
fjs.core.inherits(fjs.fdp.model.ClientFeedProxyModel, fjs.fdp.model.ProxyModel);
...
fjs.fdp.model.ClientFeedProxyModel.prototype.onSyncComplete = function() {
    ...
    if(keys.length>0) {
        ...
        this.fireEvent(fjs.fdp.model.ProxyModel.EVENT_TYPE_FEED_CHANGE, {feed:this.clientFeedName, changes:_changes});
    }
    this.changes= {};
};
 ...
 */
fjs.fdp.model.ClientFeedProxyModel.prototype.addFeedListener = function(eventType, listener) {
    switch(eventType) {
        case fjs.fdp.model.ProxyModel.EVENT_TYPE_FEED_CHANGE:
    ...
    fjs.fdp.model.ClientFeedProxyModel.super_.super_.prototype.addEventListener.call(this, eventType, listener);
};
...
fjs.fdp.model.ClientFeedProxyModel.prototype.onEntryChange = function(event) {
    ...
    if(!item) {
        if(event.feed==this.clientFeedName && this.clientFeedName!=this.feedName) {
            delete this.changes[event.xpid];
            return;
        }

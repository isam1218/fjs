...
fjs.core.inherits(fjs.fdp.DataManager, fjs.model.EventsSource);
...
fjs.fdp.DataManager.prototype.addFeedListener = function(feedName, listener) {
    ...
    proxy.addEventListener(fjs.fdp.model.ProxyModel.EVENT_TYPE_FEED_CHANGE, listener);
};
...
fjs.fdp.DataManager.prototype.removeFeedListener = function(feedName, listener) {
    var proxy = this.proxies[feedName];
    if(proxy)  {
        proxy.removeEventListener(fjs.fdp.model.ProxyModel.EVENT_TYPE_FEED_CHANGE, listener);
    }
};
...
fjs.fdp.DataManager.prototype.createProxy = function(feedName) {
    switch(feedName) {
        ...
        case 'widget_history':
            return new fjs.fdp.model.ClientFeedProxyModel(['widget_history'], this.sm);
        default :
...
fjs.fdp.DataManager.prototype.logout = function() {
    var context =this;
    this.sm.logout(function(){
        context.fireEvent('logout', {eventType:'logout'});
    });
};
/**

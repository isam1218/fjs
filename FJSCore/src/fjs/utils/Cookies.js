 ...
 */
      fjs.utils.Cookies = {
        ...
        set: function(name, value, options) {
            ...
            document.cookie = /**@type HTMLCollection*/ updatedCookie;
        },
        ...
        remove: function(name) {
          _Cookies.set(name, undefined, {expires: -1});
        }
        /**
         ...
         */
        , check: function() {
          _Cookies.set('testCookie', 'testValue');
            var val = _Cookies.get('testCookie');
          _Cookies.remove('testCookie');
            return !!val;
        }
    };
})();

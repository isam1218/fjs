describe("IFrameAjax", function () {
        it("200GETrequest", function () {
            var ajax = new fjs.ajax.IFrameAjax('http://localhost:99/crossdomainTest.html'), status, _isOk, doneFlag, response;
            runs(function () {
        ...
        it("404GETrequest", function () {
            var ajax = new fjs.ajax.IFrameAjax('http://localhost:99/crossdomainTest.html'), status, _isOk, doneFlag;
            runs(function () {

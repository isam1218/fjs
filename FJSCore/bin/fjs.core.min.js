...
(function(){namespace("fjs.utils");fjs.utils.Console=function(){};fjs.utils.Console.log=function(){console&&console.log(arguments)};fjs.utils.Console.error=function(){console&&console.error(arguments)};fjs.utils.Console.debug=function(){console&&(console.debug?console.debug(arguments):console.log(arguments))};fjs.utils.Console.warn=function(){console&&(console.warn?console.warn(arguments):console.log(arguments))};fjs.utils.Console.info=function(){console&&(console.info?console.info(arguments):console.log(arguments))}})();

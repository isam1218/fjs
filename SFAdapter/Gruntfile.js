        ...
        'concat': {
            ...
            dist: {
                src: [ 'src/js/salesforce_api/sf_api.js'
                    ...
                    , 'src/js/model/filters/callLogSort.js'
                    ...
                    , 'src/js/ui/controllers/callLogsController.js'
                    , 'src/js/ui/controllers/callLogDialogController.js'
        ...
        , 'zip': {
            'sfa-zip': {
                ...
                , src: ['src/js/bin/fjs.sf.min.js'
                    ...
                    , 'src/js/ui/module.js'
                    , 'src/build_nubmer'
                    , 'src/properties.huc_qa'
                    , 'src/properties.dev4_fon9'
                    , 'src/properties.huc-dev'
                    , 'src/properties.prod'
                ]

...
a.action)}};namespace("fjs.api");fjs.api.WebWorkerDataProvider=function(a,c,d){var b=this;fjs.api.DataProviderBase.call(this,a,c);this.worker=new Worker("js/lib/fdp_worker.js");this.worker.addEventListener("message",function(a){"ready"==a.data.eventType&&(b.sendMessage({action:"init",data:{ticket:b.ticket,node:b.node,config:fjs.fdp.CONFIG}}),d());b.fireEvent(a.data.eventType,a.data)},!1);this.worker.addEventListener("error",function(a){console.error("Worker Error",a)});this.sendMessage=function(a){b.worker.postMessage(a)}};
...
fjs.api.SharedWorkerDataProvider=function(a,c,d){var b=this;fjs.api.DataProviderBase.call(this,a,c);this.worker=new SharedWorker("js/lib/fdp_shared_worker_min.js");this.worker.port.addEventListener("message",function(a){"ready"==a.data.eventType&&(b.sendMessage({action:"init",data:{ticket:b.ticket,node:b.node,config:fjs.fdp.CONFIG}}),d());b.fireEvent(a.data.eventType,a.data)},!1);this.worker.port.addEventListener("error",function(a){console.error("Worker Error",a)});this.worker.port.start();this.sendMessage=

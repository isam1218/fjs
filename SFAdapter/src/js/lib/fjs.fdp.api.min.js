...
setTimeout(this._runMaster,this.CHANGE_TAB_TIMEOUT)};fjs.fdp.TabsSynchronizer.extend(fjs.EventsSource);fjs.fdp.TabsSynchronizer.prototype._checkMaster=function(){var a=localStorage[this.TABS_SYNCRONIZE_KEY];return!a||Date.now()-parseInt(a.split("|")[1])>this.CHANGE_TAB_TIMEOUT}})();

...
{},this.createIndexes(this.getRealTableName(d),a);else this.dbInfo={name:b,version:a},this.createTables(),self.localStorage.setItem("DB_"+b,fjs.utils.JSON.stringify(this.dbInfo));setTimeout(function(){c(e)},0)};fjs.db.LocalStorageDbProvider.check=function(){return!!self.localStorage};fjs.db.LocalStorageDbProvider.prototype.createTable=function(){};
...
if(!this.node)return this.requestClientRegistry(function(c){c&&a.requestVersions(b)});this._currentVersioncache=this._currentRequest=this.sendRequest(this.url+this.VERSIONS_PATH,b,function(c,d,e){e?(d=a.parseVersionsResponse(d))?a.syncRequest(d):a.requestVersionscache():(401==c.status||403==c.status)&&a.requestClientRegistry(function(c){c&&a.requestVersions(b)});a.handleRequestErrors(c,e)})};fjs.fdp.transport.AJAXTransport.prototype.sendAction=function(b,a,c){var d=this,a={action:a},e;for(e in c)c.hasOwnProperty(e)&&
(a["a."+e]=c[e]);this.sendRequest(this.url+"/v1/"+b,a,function(a,b,c){d.handleRequestErrors(a,c)})};fjs.fdp.transport.AJAXTransport.prototype.close=function(){this.closed=!0;this._currentRequest&&this.ajax.abort(this._currentRequest)}})();
...
b,e,a,function(f,g,h){h?c.apply(this,arguments):d.iframeAjax.send("post",b,e,a,c)}).url=b}})();

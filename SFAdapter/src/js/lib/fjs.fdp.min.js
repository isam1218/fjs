...
fjs.db.LocalStorageDbProvider.prototype.open=function(b,a,c){try{var d,e=this;this.state=0;if(this.dbInfo=fjs.utils.JSON.parse(self.localStorage.getItem("DB_"+b)))if(a>this.dbInfo.version){for(var f=0;f<this.dbInfo.tables.length;f++)d=this.dbInfo.tables[f],self.localStorage.removeItem(d);this.dbInfo.tables=null;this.dbInfo.version=a;this.createTables();self.localStorage.setItem("DB_"+b,fjs.utils.JSON.stringify(this.dbInfo))}else for(b=0;b<this.dbInfo.tables.length;b++)d=this.dbInfo.tables[b],f=this.dbData[d]=
fjs.utils.JSON.parse(self.localStorage.getItem(d))||{},this.createIndexes(this.getRealTableName(d),f);else this.dbInfo={name:b,version:a},this.createTables(),self.localStorage.setItem("DB_"+b,fjs.utils.JSON.stringify(this.dbInfo));this.state=1;c&&setTimeout(function(){c(e)},0)}catch(g){fjs.utils.Console.error("Error: can't create localStorage DB",g),c&&setTimeout(function(){c(null)},0)}};fjs.db.LocalStorageDbProvider.check=function(){return!!self.localStorage};
fjs.db.LocalStorageDbProvider.prototype.createTable=function(){};fjs.db.LocalStorageDbProvider.prototype.createTables=function(){if(this.tables){this.dbInfo.tables=[];for(var b in this.tables)this.tables.hasOwnProperty(b)&&this.dbInfo.tables.push(this.getLSTableName(b))}};fjs.db.LocalStorageDbProvider.prototype.getLSTableName=function(b){return"DB_"+this.dbInfo.name+"_"+b};fjs.db.LocalStorageDbProvider.prototype.getRealTableName=function(b){return b.replace("DB_"+this.dbInfo.name+"_","")};
...
fjs.utils.JSON.stringify(a));a.t=Date.now();localStorage.setItem("lsp_"+b,fjs.utils.JSON.stringify(a))}})();
...
function(){d.transport.send({type:"synchronize",data:{versions:b}})}):Error("You must set feeds names array")};fjs.fdp.SyncManager.prototype.saveVersions=function(a,b,d){this.db&&(void 0!==d&&(!fjs.fdp.transport.TransportFactory.useLocalStorageSyncronization()||(new fjs.api.TabsSynchronizer).isMaster))&&this.db.insertOne("versions",{feedSource:a+"_"+b,feedName:a,source:b,version:d})};fjs.fdp.SyncManager.prototype.getVersions=function(a,b,d){var e=[],f=this;this.versions[a]?setTimeout(function(){d(b[a]=
f.versions[a])},0):this.db?this.db.selectByIndex("versions",{feedName:a},function(a){e.push(a.source+"@"+a.version)},function(){f.versions[a]=b[a]=e.join(",");d(b[a])}):setTimeout(function(){d(f.versions[a]=b[a]="")},0)};fjs.fdp.SyncManager.prototype.lazySyncProcessItems=function(a,c,d){for(var e=[],f=0;f<a.length;f++){var g=a[f],h=g.xef001type||b.eventTypes.ENTRY_CHANGE,i=g.xpid=g.xpid?g.xpid:d?d+"_"+g.xef001id:g.xef001id;delete g.xef001type;g.source=d;g={eventType:h,feed:c,xpid:i,entry:g};if(this.db)switch(h){case b.eventTypes.ENTRY_CHANGE:e.push(g.entry);
break;case b.eventTypes.ENTRY_DELETION:(!fjs.fdp.transport.TransportFactory.useLocalStorageSyncronization()||(new fjs.api.TabsSynchronizer).isMaster)&&this.db.deleteByKey(c,g.xpid,null);break;default:fjs.utils.Console.error("Incorrect item change type: "+h+" for Lazy sync")}this.fireEvent(c,g)}this.db&&(0<e.length&&(!fjs.fdp.transport.TransportFactory.useLocalStorageSyncronization()||(new fjs.api.TabsSynchronizer).isMaster))&&this.db.insertArray(c,e,null)};fjs.fdp.SyncManager.prototype.fullSyncProcessItems=
function(a,c,d){for(var e=this,f=[],g=0;g<a.length;g++){var h=a[g],i=h.xef001type||b.eventTypes.ENTRY_CHANGE;h.source=d;if(i===b.eventTypes.ENTRY_CHANGE){var j=h.xpid=h.xpid?h.xpid:d?d+"_"+h.xef001id:h.xef001id;delete h.xef001type;i={eventType:i,feed:c,xpid:j,entry:h};f.push(h);this.fireEvent(c,i)}else fjs.utils.Console.error("Incorrect item change type: "+i+" for Full sync")}this.db&&(!fjs.fdp.transport.TransportFactory.useLocalStorageSyncronization()||(new fjs.api.TabsSynchronizer).isMaster)&&this.db.deleteByIndex(c,
{source:d},function(){e.db.insertArray(c,f,null)})};fjs.fdp.SyncManager.prototype.keepSyncProcessItems=function(a,c,d){for(var e=[],f=[],g=[],h=this,i=0;i<a.length;i++){var j=a[i],k=j.xef001type||b.eventTypes.ENTRY_CHANGE,l=j.xpid=j.xpid?j.xpid:d?d+"_"+j.xef001id:j.xef001id;delete j.xef001type;j.source=d;j={eventType:k,feed:c,xpid:l,entry:j};if(this.db)switch(k){case b.eventTypes.ENTRY_CHANGE:e.push(j.entry);g.push(j.entry.xpid);break;case b.eventTypes.ENTRY_KEEP:f.push(j.entry.xpid);break;default:fjs.utils.Console.error("Incorrect item change type: "+
k+" for Keep sync")}this.fireEvent(c,j)}this.db&&(0<e.length&&(!fjs.fdp.transport.TransportFactory.useLocalStorageSyncronization()||(new fjs.api.TabsSynchronizer).isMaster))&&this.db.selectByIndex(c,{source:d},function(a){0>f.indexOf(a.xpid)&&0>g.indexOf(a.xpid)&&h.db.deleteByKey(c,a.xpid,null)},function(){h.db.insertArray(c,e,null)})};fjs.fdp.SyncManager.prototype.processFeedData=function(a,c){this.fireEvent(a,{eventType:b.eventTypes.FEED_START,feed:a});for(var d in c)c.hasOwnProperty(d)&&"full"!=
d&&this.processSourceData(a,d,c[d]);this.fireEvent(a,{eventType:b.eventTypes.FEED_COMPLETE,feed:a})};fjs.fdp.SyncManager.prototype.processSourceData=function(a,c,d){var e=d.xef001ver;d.filter&&this.saveHistoryVersions(a,c,d.filter,d.h_ver);var f=d.items,d=d.xef001type;this.fireEvent(a,{eventType:b.eventTypes.SOURCE_START,syncType:d,feed:a,sourceId:c});switch(d){case b.syncTypes.LAZY:this.lazySyncProcessItems(f,a,c);break;case b.syncTypes.FULL:this.fullSyncProcessItems(f,a,c);break;case b.syncTypes.KEEP:this.keepSyncProcessItems(f,
a,c);break;default:fjs.utils.Console.error("Unknown sync type: "+d)}this.fireEvent(a,{eventType:b.eventTypes.SOURCE_COMPLETE,feed:a,sourceId:c,syncType:d});this.saveVersions(a,c,e)};fjs.fdp.SyncManager.prototype.onSync=function(a){var a=fjs.utils.JSON.parse(a),c=this;null!=this.syncTimeoutId&&(clearTimeout(this.syncTimeoutId),this.syncTimeoutId=null);this.syncs.push(a);if(1==this.syncs.length){this.fireEvent(null,{eventType:b.eventTypes.SYNC_START});for(a=0;a<this.syncs.length;a++)for(var d in this.syncs[a])this.syncs[a].hasOwnProperty(d)&&
this.processFeedData(d,this.syncs[a][d]);c.syncs=[];this.syncTimeoutId=setTimeout(function(){c.fireEvent(null,{eventType:b.eventTypes.SYNC_COMPLETE});c.syncTimeoutId=null},100)}else fjs.utils.Console.log("!!!!Double onSync!!",this.syncs[0],a)};fjs.fdp.SyncManager.prototype.sendAction=function(a,c,d){d.action=c;a={type:"action",data:{feedName:a,actionName:c,parameters:d}};this.status!=b.states.READY?this.suspendActions.push(a):this.transport.send(a)};fjs.fdp.SyncManager.prototype.onClientSync=function(a,
b){fjs.fdp.transport.TransportFactory.useLocalStorageSyncronization()&&(new fjs.api.TabsSynchronizer).isMaster?fjs.fdp.transport.LocalStorageTransport.masterSend("message",{type:"sync",data:a}):fjs.fdp.transport.TransportFactory.useLocalStorageSyncronization()&&!b&&fjs.fdp.transport.LocalStorageTransport.masterSend("clientSync",{type:"clientSync",data:a});if(!fjs.fdp.transport.TransportFactory.useLocalStorageSyncronization()||(new fjs.api.TabsSynchronizer).isMaster)if(1!=this.status)this.suspendClientSyncs.push(a);
else this.onSync(a)};fjs.fdp.SyncManager.prototype.getAuthTicket=function(){var a=this;this.state==b.states.READY&&this.db?this.db.clear(function(){a.fireEvent("authError",{type:"authError",message:"Auth ticket wrong or expired"})}):a.fireEvent("authError",{type:"authError",message:"Auth ticket wrong or expired"})};fjs.fdp.SyncManager.prototype.addFeedListener=function(a,c,d){var e=this;0>this.feeds.indexOf(a)&&this.feeds.push(a);this.superClass.addEventListener.apply(this,arguments);this.status!=
b.states.READY?d?0>this.suspendClientFeeds.indexOf(a)&&this.suspendClientFeeds.push(a):(0>this.suspendFeeds.indexOf(a)&&this.suspendFeeds.push(a),0>this.syncFeeds.indexOf(a)&&this.syncFeeds.push(a)):0>this.syncFeeds.indexOf(a)?(d||(this.syncFeeds.push(a),0>this.versionsFeeds.indexOf(a)&&this.versionsFeeds.push(a),null!=this.versionsTimeoutId&&(clearTimeout(this.versionsTimeoutId),this.versionsTimeoutId=null),this.versionsTimeoutId=setTimeout(function(){e.startSync(e.versionsFeeds);e.versionsFeeds=
[];e.versionsTimeoutId=null},100)),this.fireEvent(a,{eventType:b.eventTypes.SYNC_START,feed:a},c),this.getFeedData(a,function(d){d.eventType==b.eventTypes.FEED_COMPLETE&&e.fireEvent(a,{eventType:b.eventTypes.SYNC_COMPLETE,feed:a},c);c(d)})):0<=this.syncFeeds.indexOf(a)&&this.states==b.READY&&(this.fireEvent(a,{eventType:b.eventTypes.SYNC_START,feed:a},c),this.getFeedData(a,function(d){d.eventType==b.eventTypes.FEED_COMPLETE&&e.fireEvent(a,{eventType:b.eventTypes.SYNC_COMPLETE,feed:a},c);c(d)}))};
fjs.fdp.SyncManager.prototype.removeFeedListener=function(a,b,d){var e;(e=0<=this.feeds.indexOf(a))&&this.feeds.splice(e,1);this.superClass.removeEventListener.apply(this,arguments);d||(-1<(e=this.syncFeeds.indexOf(a))&&this.syncFeeds.splice(e,1),this.listeners[a]&&0==this.listeners[a].length&&this.transport.send({type:"forget",data:{feedName:a}}))};fjs.fdp.SyncManager.prototype.getFeedData=function(a,c){var d=this;this.fireEvent(a,{eventType:b.eventTypes.FEED_START,syncType:"F",feed:a},c);this.db?
this.db.selectAll(a,function(e){d.fireEvent(a,{eventType:b.eventTypes.ENTRY_CHANGE,feed:a,xpid:e.xpid,entry:e},c)},function(){d.fireEvent(a,{eventType:b.eventTypes.FEED_COMPLETE,feed:a},c)}):this.fireEvent(a,{eventType:b.eventTypes.FEED_COMPLETE,feed:a},c)};fjs.fdp.SyncManager.prototype.fireEvent=function(a,b,d){if(d)d(b);else if(a)this.superClass.fireEvent.call(this,a,b);else for(var e in this.listeners)this.listeners.hasOwnProperty(e)&&-1<this.feeds.indexOf(e)&&this.superClass.fireEvent.call(this,

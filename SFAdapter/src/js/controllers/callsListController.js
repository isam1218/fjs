...
fjs.controllers.CallsListController = function($scope) {
    var callsFeedModel = SFApp.feedModels["mycalls"];
    var sfApi = new SFApi();
    ...
    callsFeedModel.addListener("push", function(data){
    ...
    callsFeedModel.addListener("changepid", function(data){
        console.log("Data changepid ", data);
        if(data.eventType=="changepid") {
    ...
    callsFeedModel.addListener("delete", function(data){
    ...
    callsFeedModel.addListener("complete", function(){

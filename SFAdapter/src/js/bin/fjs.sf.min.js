...
SFApi.prototype.addCallLog=function(a,b,d,c,e,f,i,h){var g="Completed";null==b&&null==b&&(g="Not Started");var j="Subject="+encodeURIComponent(a)+"&CallType="+e+"&CallDurationInSeconds="+f+"&Status="+g+"&Type=Call&ActivityDate="+i;b&&(j+="&WhoId="+b);d&&(j+="&WhatId="+d);SFApi.prototype.getCalllogCommentField(function(a){var b="Description";a&&a.result&&(null!=a.result&&""!=a.result)&&(b=a.result);j+="&"+b+"="+encodeURIComponent(c);f&&i&&e?sforce.interaction.saveLog("Task",j,function(a){h(a)}):console.error("Wrong arguments for adding call log.")})};
...
fjs.controllers.CallController=function(a,b,d,c,e,f){function i(){var b=new Date,f=b.getTime()-v.getDefault()+6E4*(new Date(1)).getTimezoneOffset(),e=f-a.call.created,f=f-a.call.holdStart;a.duration=c("date")(new Date(e),"HH:mm:ss ");a.call.duration=b.getTime()-(a.call.created+v.getDefault());a.onHold&&(a.holdDuration=c("date")(new Date(f),"HH:mm:ss "));o=d(i,fjs.controllers.CallController.CALL_DURATION_DELAY_IN_SEC)}function h(b){var c={},d=null,f=0;if(b&&b.result){b=JSON.parse(b.result);a.call.mycallsclient_callLog.what=
...
id:d._id});else for(h in c){f=c[h];f.sort(j);a.call.mycallsclient_callLog.fields.push({title:h+" ("+f.length+")",value:f[0][fjs.controllers.CallController.SORT_FIELD_NAME],id:f[0]._id});for(d=1;d<f.length;d++)a.call.mycallsclient_callLog.fields.push({title:"",value:f[d][fjs.controllers.CallController.SORT_FIELD_NAME],id:f[d]._id})}}s();e.sendAction("mycallsclient","push",{callLog:a.call.mycallsclient_callLog,xpid:a.call.xpid});x.safeApply(a)}function g(){if(y=a.call.phone){var b=a.call.phone.replace(/\(|\)|-/g,
"");10<b.length&&(b=b.slice(b.length-10,b.length));if(a.call.type!=fjs.controllers.CallController.SYSTEM_CALL_TYPE){var c={action:"getPhoneInfo",data:{}};c.data.phone=b;c.data.callType=a.call.incoming?"inbound":"outbound";c.data.isRinging=0==a.call.state;c.callback=h;p.sendAction(c)}else s(),e.sendAction("mycallsclient","push",{callLog:a.call.mycallsclient_callLog,xpid:a.call.xpid});k=d(g,fjs.controllers.CallController.CALL_GET_INFO_DELAY_IN_SEC)}}function j(a,b){if(a[fjs.controllers.CallController.SORT_FIELD_NAME]&&
...
n(0)||l(0)):t()||l(0);else if(a.call.mycallsclient_callLog&&a.call.mycallsclient_callLog.whoId&&a.who){for(var c=!1,b=0;b<a.call.mycallsclient_callLog.who.length;b++)if(a.call.mycallsclient_callLog.who[b]._id==a.call.mycallsclient_callLog.whoId){c=!0;break}c||(a.call.mycallsclient_callLog.who&&a.call.mycallsclient_callLog.who[0]?(a.call.mycallsclient_callLog.whoId=a.call.mycallsclient_callLog.who[0]._id,n(0)||l(a.call.mycallsclient_callLog.whatId)):t()||l(a.call.mycallsclient_callLog.whatId))}else if(a.call.mycallsclient_callLog&&
a.call.mycallsclient_callLog.whatId&&a.what){for(b=0;b<a.call.mycallsclient_callLog.what.length&&a.call.mycallsclient_callLog.what[b]._id!=a.mycallsclient_callLog.whatId;b++);c||l(0)}}function t(){if(u())for(var b=0;b<a.who.length;b++)if(a.call.mycallsclient_callLog.who[b]._id==a.call.mycallsclient_callLog.whoId)return n(b)}function u(){return null!=a.call.mycallsclient_callLog&&null!=a.call.mycallsclient_callLog.who&&null!=a.call.mycallsclient_callLog.whoId}function l(b){null==a.call.mycallsclient_callLog.whatId&&
(null!=a.call.mycallsclient_callLog.what&&null!=a.call.mycallsclient_callLog.what[b])&&(a.call.mycallsclient_callLog.whatId=a.call.mycallsclient_callLog.what[b]._id)}function n(b){return a.call.mycallsclient_callLog&&"Lead"==a.call.mycallsclient_callLog.who[b].object}function w(){a.call.mycallsclient_callLog.isOpened=!1;a.call.mycallsclient_callLog.triangle=fjs.controllers.CallController.CLOSED_TRIANGLE;e.sendAction("mycallsclient","push",{callLog:a.call.mycallsclient_callLog,xpid:a.call.xpid})}function q(){a.call.mycallsclient_callLog.isOpened=
!0;a.call.mycallsclient_callLog.triangle=fjs.controllers.CallController.OPENED_TRIANGLE;e.sendAction("mycallsclient","push",{callLog:a.call.mycallsclient_callLog,xpid:a.call.xpid})}function r(){a.transferDialogPath=null;a.isTransferDialogClass=""}fjs.controllers.CommonController(this);e.getModel("mycallsclient");var o=null,k=null,v=new fjs.utils.TimeSync,y=null,x=this,m=null,p=f.getProvider();a.templatePath="templates/call_item.html";a.callLogPath="templates/call_log.html";a.transferDialogPath=null;
a.onHold=a.call.state==fjs.controllers.CallController.HOLD_CALL_TYPE;a.isRing=a.call.state==fjs.controllers.CallController.RING_CALL_TYPE;a.call.mycallsclient_callLog||(a.call.mycallsclient_callLog={},b=a.call.mycallsclient_callLog,f=new Date,f=f.getFullYear()+"-"+(f.getMonth()+1)+"-"+f.getDate(),b.date=f,a.call.mycallsclient_callLog.subject="Call",a.call.mycallsclient_callLog.xpid=a.call.xpid,a.call.mycallsclient_callLog.isOpened=!0,a.call.mycallsclient_callLog.note="",a.call.mycallsclient_callLog.callType=
a.call.incoming?"inbound":"outbound",a.call.mycallsclient_callLog.triangle=fjs.controllers.CallController.OPENED_TRIANGLE);(void 0==a.call.mycallsclient_isOpened&&a.isRing||a.call.type==fjs.controllers.CallController.CONFERENCE_CALL_TYPE&&a.call.state==fjs.controllers.CallController.TALCKING_CALL_TYPE)&&a.$emit("selectCall",a.call);i();a.whoChange=function(){if(u()){for(var b=0;b<a.call.mycallsclient_callLog.who.length;b++)if(a.call.mycallsclient_callLog.who[b]._id==a.call.mycallsclient_callLog.whoId){n(b)?
a.call.mycallsclient_callLog.whatId=null:l(0);break}e.sendAction("mycallsclient","push",{callLog:a.call.mycallsclient_callLog,xpid:a.call.xpid})}};a.whatChange=function(){e.sendAction("mycallsclient","push",{callLog:a.call.mycallsclient_callLog,xpid:a.call.xpid})};a.noteChange=function(){if(m!=null){clearTimeout(m);m=null}m=setTimeout(function(){e.sendAction("mycallsclient","push",{callLog:a.call.mycallsclient_callLog,xpid:a.call.xpid})},fjs.controllers.CallController.CALL_LOG_CHANGE_DELAY_IN_SEC)};
a.$watch("call.state",function(){a.onHold=a.call.state==fjs.controllers.CallController.HOLD_CALL_TYPE;if(!a.onHold){var b=(new Date(0)).getTime()+(new Date(0)).getTimezoneOffset()*6E4;a.holdDuration=c("date")(b,"HH:mm:ss ")}a.isRing=a.call.state==fjs.controllers.CallController.RING_CALL_TYPE},!0);a.$watch("call.phone",function(){g()});a.showDetails=function(){a.$emit("toggleCall",a.call)};a.hold=function(){e.sendAction(fjs.model.MyCallsFeedModel.NAME,"transferToHold",{mycallId:a.call.xpid});return false};
a.accept=function(){e.sendAction(fjs.model.MyCallsFeedModel.NAME,"answer",{mycallId:a.call.xpid});return false};a.transfer=function(){a.transferDialogPath="templates/transfer_dialog.html";a.isTransferDialogClass="call-item-transfer-opened";a.callLogPath&&w()};a.end=function(){e.sendAction(fjs.model.MyCallsFeedModel.NAME,"hangup",{mycallId:a.call.xpid});return false};a.unhold=function(){e.sendAction(fjs.model.MyCallsFeedModel.NAME,"transferFromHold",{mycallId:a.call.xpid});return false};a.toggleCallLog=
function(){if(a.call.mycallsclient_callLog.isOpened)w();else{q();r()}};a.openSFLink=function(a){var b={action:"openUser",data:{}};b.data.id=a;p.sendAction(b)};a.$on("closeDialog",function(){r();q()});a.$on("transfer",function(b,c){c&&c!=""&&e.sendAction(fjs.model.MyCallsFeedModel.NAME,"transferTo",{mycallId:a.call.xpid,toNumber:c});r();q()});a.$on("$destroy",function(){o&&d.cancel(o);if(k){d.cancel(k);k=null}if(a.call.mycallsclient_callLog&&a.call.type!=fjs.controllers.CallController.SYSTEM_CALL_TYPE){a.call.mycallsclient_callLog.subject=
a.call.mycallsclient_callLog.note&&a.call.mycallsclient_callLog.note!=""?"Call: "+a.call.mycallsclient_callLog.note.substr(0,240)+" ...":"Call";var b={action:"addCallLog",data:{}};b.data.subject=a.call.mycallsclient_callLog.subject;b.data.whoId=a.call.mycallsclient_callLog.whoId;b.data.whatId=a.call.mycallsclient_callLog.whatId;b.data.note=a.call.mycallsclient_callLog.note;b.data.callType=a.call.incoming?"inbound":"outbound";b.data.duration=Math.round(a.call.duration/1E3);b.data.date=a.call.mycallsclient_callLog.date;
b.callback=function(a){console.error(a)};p.sendAction(b)}clearTimeout(m)});a.$watch("call.mycallsclient_isOpened",function(){if(a.call.mycallsclient_isOpened)k||(k=d(g,fjs.controllers.CallController.CALL_GET_INFO_DELAY_IN_SEC));else if(k){d.cancel(k);k=null}})};fjs.controllers.CallController.extend(fjs.controllers.CommonController);fjs.controllers.CallController.CONFERENCE_CALL_TYPE=0;fjs.controllers.CallController.SYSTEM_CALL_TYPE=7;fjs.controllers.CallController.HOLD_CALL_TYPE=3;
...
{};a.mycallsclient_isOpened=c.isOpened=!1;c.xpid=a.xpid;if(c.xpid)b.sendAction("mycallsclient","push",c);else debugger}},e=function(d){if(!d.mycallsclient_isOpened){var e={};d.mycallsclient_isOpened=e.isOpened=!0;e.xpid=d.xpid;if(e.xpid)b.sendAction("mycallsclient","push",e);else debugger}d=d.xpid;for(e=0;e<a.calls.length;e++){var h=a.calls[e];h.xpid!=d&&h.mycallsclient_isOpened&&c(h)}}};fjs.controllers.CallsListController.extend(fjs.controllers.CommonController);
...
200;this.FRAME_RESIZE_NAME="resizeFrame";a.isConnected=!0;a.warningsTemplatePath="templates/warnings.html";a.isWarningsShown=!1;a.loggined=!0;a.connection=!0;a.phone=!0;a.isLocationRegistered=!0;var f=function(){null!=g&&(clearTimeout(g),g=null);g=setTimeout(function(){var a=i.clientHeight;if(a!=h){var b={action:"setSoftphoneHeight",data:{}};b.data.height=i.clientHeight;b.callback=function(){g=null};e.sendAction(b)}h=a},100)},d={action:"setSoftphoneHeight",data:{}};d.data.height=c.SOFTPHONE_HEIGHT;
e.sendAction(d);d={action:"setSoftphoneWidth",data:{}};d.data.height=c.SOFTPHONE_WIDTH;e.sendAction(d);var i=document.getElementById(c.FRAME_RESIZE_NAME),h=i.clientHeight,g=null;document.body.onresize=function(){f()};setTimeout(function(){frame.onresize=function(){f()}},200);a.showWarnings=function(){a.isWarningsShown=!0;c.safeApply(a);b.sendAction(fjs.controllers.MainController.CLIENT_SETTINGS_FEED_MODEL,"push",{xpid:fjs.controllers.MainController.IS_WARNING_SHOWN,value:a.isWarningsShown})};a.hideWarnings=
function(){a.isWarningsShown=!1;c.safeApply(a);b.sendAction(fjs.controllers.MainController.CLIENT_SETTINGS_FEED_MODEL,"push",{xpid:fjs.controllers.MainController.IS_WARNING_SHOWN,value:a.isWarningsShown})};a.toggleWarnings=function(){a.isWarningsShown?a.hideWarnings():a.showWarnings()};var j=function(){a.isWarningsButtonShown=!a.loggined||!a.connection||!a.isLocationRegistered;a.loggined&&(a.connection&&a.isLocationRegistered)&&(a.isWarningsShown=!1);c.safeApply(a)};this.meListener=function(){var b=
c.meModel.getProperty("display_name");a.name=b?"User: "+b:"";b=c.meModel.getProperty("primary_extension");a.extension=b?"Extension: x"+b:"";c.safeApply(a)};this.authorizationWarningListener=function(b){a.loggined=b;j();a.isConnected=a.connection&&a.loggined;c.safeApply(a)};this.connectionWarningListener=function(b){setTimeout(function(){a.connection=b;j();a.isConnected=a.connection&&a.loggined;c.safeApply(a)},1E3)};a.$on("onLocationStatus",function(b,d){a.isLocationRegistered=d;j();c.safeApply(a)});

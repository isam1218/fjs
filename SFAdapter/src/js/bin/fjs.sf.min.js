...
c){c&&f.sendAction(fjs.model.MyCallsFeedModel.NAME,"transferTo",{mycallId:a.call.xpid,toNumber:c});g()});var s=function(b){b=b||a;return b.showSaveCallLogDialog?b.showSaveCallLogDialog:s(b.$parent)};a.callLogAvailable=function(){return a.call.type==fjs.controllers.CallController.EXTERNAL_CALL};a.$on("$destroy",function(){k&&d.cancel(k);if(a.call.type==fjs.controllers.CallController.SYSTEM_CALL_TYPE)if(a.call.mycallsclient_callLog&&0<a.call.mycallsclient_callLog.related.length&&a.call.type!=fjs.controllers.CallController.SYSTEM_CALL_TYPE){if(a.call.type==
fjs.controllers.CallController.QUEUE_CALL_TYPE&&a.call.state==fjs.controllers.CallController.RING_CALL_TYPE&&a.call.incoming){console.log("Skip queue ring callLog",a.callLog);return}var b={action:"addCallLog",data:{}};b.data.subject=a.call.mycallsclient_callLog.subject;b.data.whoId=a.call.mycallsclient_callLog.whoId;b.data.whatId=a.call.mycallsclient_callLog.whatId;b.data.note=a.call.mycallsclient_callLog.note;b.data.callType=a.call.incoming?"inbound":"outbound";b.data.duration=Math.round(((new Date).getTime()-
(a.call.created+n.getDefault()))/1E3);b.data.date=a.call.mycallsclient_callLog.date;b.callback=function(a){fjs.utils.Console.error(a)};q.sendAction(b)}else if(a.call.type!=fjs.controllers.CallController.SYSTEM_CALL_TYPE){var c=s();h(function(){c(a.call)})}l=null;clearTimeout(o)})};fjs.controllers.CallController.extend(fjs.controllers.CommonController);fjs.controllers.CallController.CONFERENCE_CALL_TYPE=0;fjs.controllers.CallController.SYSTEM_CALL_TYPE=7;

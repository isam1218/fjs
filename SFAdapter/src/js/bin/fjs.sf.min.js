...
namespace("fjs.model");fjs.model.MyCallEntryModel=function(a){var b=new Date(a.created);this.mycallsclient_callLog={date:b.getFullYear()+"-"+(b.getMonth()+1)+"-"+b.getDate(),subject:fjs.model.MyCallEntryModel.prototype.getCallSubject.call(a),xpid:a.xpid,note:"",callType:a.incoming?"inbound":"outbound",isOpened:!0,tranferOpened:!1,whatId:null,whoId:null,related:[]};fjs.model.EntryModel.call(this,a)};fjs.model.MyCallEntryModel.extend(fjs.model.EntryModel);
fjs.model.MyCallEntryModel.prototype.getCallSubject=function(){var a=[],b=new Date(this.created);a.push(this.incoming?"Inbound":"Outbound");a.push("Call");a.push(function(a){var b=a.getDate().toString(),e=(a.getMonth()+1).toString(),a=a.getFullYear().toString(),b=1<b.length?b:"0"+b,e=1<e.length?e:"0"+e;return e+"/"+b+"/"+a}(b));return a.join(" ")};
...
fjs.model.MyCallEntryModel.prototype.fillCallLogData=function(a,b){var c=this.mycallsclient_callLog.whatId,d=this.mycallsclient_callLog.whoId,e=!1;this.mycallsclient_callLog._notNew||(this.mycallsclient_callLog._notNew=e=!0);this.pidChanged&&(e=!0,this.pidChanged=!1);var f=b.items.phoneMap&&b.items.phoneMap.phones||{};if(a&&a.result){var j=fjs.utils.JSON.parse(a.result),i;for(i in j)if(j.hasOwnProperty(i)&&"screenPopUrl"!=i&&"CaseComment"!=j[i].object){var g=j[i];g._id=i;"Case"==g.object&&(g.Name=
g.CaseNumber);var h=this.findCallLogTargetById(i);h?h.Name!=g.Name&&(h.Name=g.Name,e=!0):(h=g,this.mycallsclient_callLog.related.push(h),e=!0);h.new=!0}}j=this.mycallsclient_callLog.related.slice(0);for(i=0;i<j.length;i++)if(g=j[i],g.new)g.new=!1;else{var k=this.mycallsclient_callLog.related.indexOf(g);-1<k&&(this.mycallsclient_callLog.related.splice(k,1),this.mycallsclient_callLog.pervWhatId==g._id&&(this.mycallsclient_callLog.pervWhatId=null),e=!0)}fjs.model.filter.SortRelatedFields()(this.mycallsclient_callLog.related);
(f=f[this.phone])&&(h=this.findCallLogTargetById(f.id))?"who"==this.getRelatedItemType(h)?(this.mycallsclient_callLog.whoId=f.id,"Lead"==h.object&&(this.mycallsclient_callLog.whatId=null)):(h=this.getWho(!0),this.mycallsclient_callLog.whoId=h&&h._id,this.mycallsclient_callLog.whatId=f.id):(h=this.findCallLogTargetById(this.mycallsclient_callLog.whoId),h||(h=this.getWho(),this.mycallsclient_callLog.whoId=h&&h._id));f&&b.deletePhone(this.phone);return e||c!=this.mycallsclient_callLog.whatId||d!=this.mycallsclient_callLog.whoId};
fjs.model.MyCallEntryModel.prototype.fill=function(a,b){b=b||this;if(a)for(var c in a)if(a.hasOwnProperty(c)){var d=a[c];if("object"!=typeof d||null==d){if("note"!=c||!this._blockChangeNote)b[c]=d}else Array.isArray(d)?b[c]=[]:b[c]||(b[c]={}),this.fill(d,b[c])}};fjs.model.MyCallEntryModel.prototype.showRelated=function(){var a=this.findCallLogTargetById(this.mycallsclient_callLog.whoId);return this.getWhat()&&(!a||"Lead"!=a.object)};namespace("fjs.model");
fjs.model.ClientSettingsFeedModel=function(a){fjs.model.FeedModel.call(this,"clientsettings",a)};fjs.model.ClientSettingsFeedModel.extend(fjs.model.FeedModel);fjs.model.ClientSettingsFeedModel.prototype.savePhone=function(a,b){if(this.items.phoneMap)this.items.phoneMap.phones[a]=b,this.dataManager.sendAction("clientsettings","push",this.items.phoneMap);else{var c={xpid:"phoneMap",phones:{}};c.phones[a]=b;this.dataManager.sendAction("clientsettings","push",c)}};
fjs.model.ClientSettingsFeedModel.prototype.deletePhone=function(a){this.items.phoneMap&&(delete this.items.phoneMap.phones[a],this.dataManager.sendAction("clientsettings","push",this.items.phoneMap))};namespace("fjs.model");fjs.model.ClientCallLogFeedModel=function(a){fjs.model.FeedModel.call(this,"clientcalllog",a)};fjs.model.ClientCallLogFeedModel.extend(fjs.model.FeedModel);
fjs.model.ClientCallLogFeedModel.prototype.onEntryChange=function(a){var b=this.items[a.xpid];b?b.fill(a.entry):(b=this.items[a.xpid]=new fjs.model.CallLogEntryModel(a.entry),this.order.push(b));this.prepareEntry(b);this.fireEvent(fjs.model.FeedModel.EVENT_TYPE_PUSH,b)};fjs.model.CallLogEntryModel=function(a){fjs.model.EntryModel.call(this,a)};fjs.model.CallLogEntryModel.extend(fjs.model.EntryModel);
fjs.model.CallLogEntryModel.prototype.fill=function(a,b){b=b||this;if(a)for(var c in a)if(a.hasOwnProperty(c)){var d=a[c];if("object"!=typeof d||null==d){if("note"!=c||!this._blockChangeNote)b[c]=d}else Array.isArray(d)?b[c]=[]:b[c]||(b[c]={}),this.fill(d,b[c])}};
fjs.model.CallLogEntryModel.prototype.getCallSubject=function(){var a=[],b=new Date(this.created);a.push(this.incoming?"Inbound":"Outbound");a.push("Call");a.push(function(a){var b=a.getDate().toString(),e=(a.getMonth()+1).toString(),a=a.getFullYear().toString(),b=1<b.length?b:"0"+b,e=1<e.length?e:"0"+e;return e+"/"+b+"/"+a}(b));return a.join(" ")};namespace("fjs.model.filter");fjs.model.filter.What=function(){return function(a){return a.filter(function(a){return"Contact"!=a.object&&"Lead"!=a.object})}};
namespace("fjs.model.filter");fjs.model.filter.Who=function(){return function(a){return a.filter(function(a){return"Contact"==a.object||"Lead"==a.object})}};namespace("fjs.model.filter");
...
fjs.controllers.CallController=function(a,b,c,d,e,f,j){function i(b){if((m=a.call.phone)&&(!a.call.mycallsclient_callLog._notNew||b)&&a.call.type!=fjs.controllers.CallController.SYSTEM_CALL_TYPE){var c={action:"getPhoneInfo",data:{}};c.data.phone=a.call.getFormattedPhone();c.data.callType=a.call.incoming?"inbound":"outbound";c.data.isRinging=0==a.call.state;c.callback=function(c){a.call.fillCallLogData(c,s)&&(g(),p&&p.safeApply(a));b&&b(c)};q.sendAction(c)}}function g(){null!=o&&clearTimeout(o);o=
setTimeout(function(){f.sendAction("mycallsclient","push",{callLog:a.call.mycallsclient_callLog,xpid:a.call.xpid})},fjs.controllers.CallController.CALL_LOG_CHANGE_DELAY_IN_SEC)}function h(){a.call.mycallsclient_callLog.isOpened=!0;a.call.mycallsclient_callLog.tranferOpened=!1;g()}fjs.controllers.CommonController(this);var k=null,l=new fjs.utils.TimeSync,m=null,p=this,o=null,q=j.getProvider(),s=f.getModel("clientsettings"),t=f.getModel("me"),u=f.getModel("locations");a.getTriangle=function(){return e.trustAsHtml(a.call.mycallsclient_callLog.isOpened?
fjs.controllers.CallController.OPENED_TRIANGLE:fjs.controllers.CallController.CLOSED_TRIANGLE)};a.isAutoAnswer=function(){var b=t.getProperty("current_location"),b=u.getEntryByXpid(b);return a.call.incoming&&b&&b.location_status_autoAnswer};var r=function(){var b=(new Date).getTime()-l.getDefault()+6E4*(new Date(1)).getTimezoneOffset(),e=b-a.call.created,b=b-a.call.holdStart;a.call.duration=d("date")(new Date(e),"HH:mm:ss ");a.call.onHold()&&(a.call.holdDuration=d("date")(new Date(b),"HH:mm:ss "));
...
a.call.mycallsclient_callLog.whatId,a.call.mycallsclient_callLog.whatId=null):null==a.call.mycallsclient_callLog.whatId&&a.call.mycallsclient_callLog.pervWhatId&&(a.call.mycallsclient_callLog.whatId=a.call.mycallsclient_callLog.pervWhatId);g()};a.whatChange=function(){g()};a.noteChange=function(){g()};a.$watch("call.phone",function(b,c){b!=c&&(a.call.mycallsclient_callLog._notNew=!1);i()});a.hold=function(){f.sendAction(fjs.model.MyCallsFeedModel.NAME,"transferToHold",{mycallId:a.call.xpid});return!1};
a.accept=function(){f.sendAction(fjs.model.MyCallsFeedModel.NAME,"answer",{mycallId:a.call.xpid});return!1};a.transfer=function(){a.call.mycallsclient_callLog.tranferOpened?(a.call.mycallsclient_callLog.tranferOpened=!1,a.call.mycallsclient_callLog.isOpened=!0):(a.call.mycallsclient_callLog.tranferOpened=!0,a.call.mycallsclient_callLog.isOpened=!1);g()};a.end=function(){f.sendAction(fjs.model.MyCallsFeedModel.NAME,"hangup",{mycallId:a.call.xpid});return!1};a.unhold=function(){f.sendAction(fjs.model.MyCallsFeedModel.NAME,
"transferFromHold",{mycallId:a.call.xpid});return!1};a.toggleCallLog=function(){a.call.mycallsclient_callLog.isOpened?(a.call.mycallsclient_callLog.isOpened=!1,g()):h()};a.createContact=function(){(new SFApi).openCreateContactDialog(a.call.phone)};a.openSFLink=function(a){var b={action:"openUser",data:{}};b.data.id=a;q.sendAction(b)};a.closeTransferDialog=function(){h()};a.$on("transfer",function(b,c){c&&f.sendAction(fjs.model.MyCallsFeedModel.NAME,"transferTo",{mycallId:a.call.xpid,toNumber:c});
h()});a.callLogAvailable=function(){return a.call.type==fjs.controllers.CallController.EXTERNAL_CALL};a.$on("$destroy",function(){k&&c.cancel(k);a.call.type==fjs.controllers.CallController.EXTERNAL_CALL&&i(function(){f.sendAction("clientcalllog","push",{callLog:a.call.mycallsclient_callLog,incoming:a.call.incoming,created:a.call.created,ended:Date.now(),xpid:a.call.xpid})});p=null;clearTimeout(o)})};fjs.controllers.CallController.extend(fjs.controllers.CommonController);
fjs.controllers.CallController.CONFERENCE_CALL_TYPE=0;fjs.controllers.CallController.SYSTEM_CALL_TYPE=7;fjs.controllers.CallController.QUEUE_CALL_TYPE=3;fjs.controllers.CallController.EXTERNAL_CALL=5;fjs.controllers.CallController.HOLD_CALL_TYPE=3;fjs.controllers.CallController.RING_CALL_TYPE=0;fjs.controllers.CallController.TALCKING_CALL_TYPE=2;fjs.controllers.CallController.OPENED_TRIANGLE="&#9660;";fjs.controllers.CallController.CLOSED_TRIANGLE="&#9658;";
fjs.controllers.CallController.SORT_FIELD_NAME="Name";fjs.controllers.CallController.CALL_GET_INFO_DELAY_IN_SEC=3E3;fjs.controllers.CallController.CALL_DURATION_DELAY_IN_SEC=1E3;fjs.controllers.CallController.CALL_LOG_CHANGE_DELAY_IN_SEC=500;namespace("fjs.controllers");
...
fjs.controllers.CallLogDialogController=function(a,b,c,d,e,f,j){function i(){null!=g&&clearTimeout(g);g=setTimeout(function(){f.sendAction("clientcalllog","push",{callLog:a.log.callLog,xpid:a.log.xpid})},fjs.controllers.CallController.CALL_LOG_CHANGE_DELAY_IN_SEC)}fjs.controllers.CommonController(this);var g=null,h=null,k=new fjs.utils.TimeSync,l=j.getProvider(),m=function(b){for(var c=0;c<a.log.callLog.related.length;c++){var d=a.log.callLog.related[c];if(d._id==b)return d}};a.noteKeyPress=function(){a.log._blockChangeNote=
!0;null!=h&&(clearTimeout(h),h=null);h=setTimeout(function(){delete a.log._blockChangeNote;h=null},1E3)};a.whoChange=function(){var b=m(a.log.callLog.whoId);b&&"Lead"==b.object?(a.log.callLog.pervWhatId=a.log.callLog.whatId,a.log.callLog.whatId=null):null==a.log.callLog.whatId&&a.log.callLog.pervWhatId&&(a.log.callLog.whatId=a.log.callLog.pervWhatId);i()};a.whatChange=function(){i()};a.getRelatedItemType=function(a){return"Contact"==a.object||"Lead"==a.object?"who":"what"};a.getWho=function(b){for(var c=
...
a.log.getCallSubject();b.data.whoId=a.log.callLog.whoId;b.data.whatId=a.log.callLog.whatId;b.data.note=a.log.callLog.note;b.data.callType=a.log.incoming?"inbound":"outbound";b.data.duration=Math.round(((new Date).getTime()-(a.log.created+k.getDefault()))/1E3);b.data.date=a.log.callLog.date;b.callback=function(a){fjs.utils.Console.error(a)};l.sendAction(b)}a.closeDialog()};a.closeDialog=function(){f.sendAction("clientcalllog","delete",{callLog:a.log.callLog,xpid:a.log.xpid})};a.cancelComment=function(){confirm("All entered information will be lost. Do you want to continue?")&&
(a.log.callLog&&(a.log.callLog.note=""),a.saveCallLog())}};fjs.controllers.CallLogDialogController.extend(fjs.controllers.CommonController);namespace("fjs.controllers");
...
e.safeApply(a))});this.meModel=c.getModel(fjs.model.MeModel.NAME);this.SOFTPHONE_HEIGHT=this.SOFTPHONE_WIDTH=200;this.FRAME_RESIZE_NAME="resizeFrame";a.isConnected=!0;a.warningsTemplatePath="templates/warnings.html";a.isWarningsShown=!1;a.loggined=!0;a.connection=!0;a.phone=!0;a.isLocationRegistered=!0;a.fdpConfigured=!0;a.fdpErrorMessage="";a.dialogTemplate=null;a.dialogModel=null;var g=function(){var a=fjs.utils.Browser;if(h.clientHeight!=k&&(a.isIE()||a.isSafari()))b[0].style.visibility="hidden";
null!=l&&(clearTimeout(l),l=null);l=setTimeout(function(){var c=h.clientHeight;if(c!=k){var d={action:"setSoftphoneHeight",data:{}};d.data.height=h.clientHeight;d.callback=function(){l=null};f.sendAction(d)}if(a.isIE()||a.isSafari())b[0].style.visibility="visible";k=c},100)},d={action:"setSoftphoneHeight",data:{}};d.data.height=e.SOFTPHONE_HEIGHT;f.sendAction(d);d={action:"setSoftphoneWidth",data:{}};d.data.width=e.SOFTPHONE_WIDTH;f.sendAction(d);var h=document.getElementById(e.FRAME_RESIZE_NAME),
k=h.clientHeight,l=null;document.body.onresize=function(){g()};setTimeout(function(){frame.onresize=function(){g()}},200);a.showBrowserWarning=function(){if(null===i){var a=!0;if(fjs.utils.Browser.isSafari())try{window.openDatabase("test","","test",1024)}catch(b){a=!1}i=!fjs.utils.Cookies.check()||!fjs.utils.LocalStorage.check()||!a}return i&&!j};a.getBrowserWarningLink=function(){return"http://www.fonality.com/crmlink/"+fjs.utils.Browser.getBrowserName()};a.getBrowserWarningMessage=function(){return"Click here for "+
fjs.utils.Browser.getBrowserName()+" instructions."};a.closeBrowserWarning=function(){j=!0};a.showWarnings=function(){a.isWarningsShown=!0;e.safeApply(a);c.sendAction(fjs.controllers.MainController.CLIENT_SETTINGS_FEED_MODEL,"push",{xpid:fjs.controllers.MainController.IS_WARNING_SHOWN,value:a.isWarningsShown})};a.showLoadingPanel=function(){return!a.name&&!a.isWarningsShown&&a.loggined&&a.connection&&a.fdpConfigured};a.hideWarnings=function(){a.isWarningsShown=!1;e.safeApply(a);c.sendAction(fjs.controllers.MainController.CLIENT_SETTINGS_FEED_MODEL,

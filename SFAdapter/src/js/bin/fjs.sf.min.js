...
SFApi.prototype.addCallLog=function(a,b,d,c,e,f,j,g){var h="Subject="+encodeURIComponent(a)+"&CallType="+e+"&CallDurationInSeconds="+f+"&Status=Completed&Type=Call&ActivityDate="+j;b&&(h+="&WhoId="+b);d&&(h+="&WhatId="+d);SFApi.prototype.getCalllogCommentField(function(a){var b="Description";a&&a.result&&(null!=a.result&&""!=a.result)&&(b=a.result);c&&(h+="&"+b+"="+encodeURIComponent(c));f&&j&&e?sforce.interaction.saveLog("Task",h,function(a){g(a)}):fjs.utils.Console.error("Wrong arguments for adding call log.")})};
SFApi.prototype.getPhoneInfo=function(a,b,d,c){sforce.interaction.searchAndGetScreenPopUrl(a,"",b,c)};SFApi.prototype.getPhoneInfoAndOpenPopup=function(a,b,d,c){sforce.interaction.searchAndScreenPop(a,"acc10="+b+"&con10="+b+"&lea8="+b,d,c)};SFApi.prototype.openUser=function(a,b){sforce.interaction.screenPop("/"+a,!0,b)};SFApi.prototype.openCreateContactDialog=function(a){sforce.interaction.screenPop("/003/e?acc10="+a+"&con10="+a+"&lea8="+a,!0,function(){})};
...
fjs.model.MyCallEntryModel.prototype.fillCallLogData=function(a,b){var d=this.mycallsclient_callLog.whatId,c=this.mycallsclient_callLog.whoId,e=!1;this.mycallsclient_callLog._notNew||(this.mycallsclient_callLog._notNew=e=!0);this.pidChanged&&(e=!0,this.pidChanged=!1);var f=b.items.phoneMap&&b.items.phoneMap.phones||{};if(a&&a.result){var j=fjs.utils.JSON.parse(a.result),g;for(g in j)if(j.hasOwnProperty(g)&&"screenPopUrl"!=g&&"CaseComment"!=j[g].object){var h=j[g];h._id=g;"Case"==h.object&&(h.Name=
h.CaseNumber);var i=this.findCallLogTargetById(g);i?i.Name!=h.Name&&(i.Name=h.Name,e=!0):(i=h,this.mycallsclient_callLog.related.push(i),e=!0);i.new=!0}}j=this.mycallsclient_callLog.related.slice(0);for(g=0;g<j.length;g++)if(h=j[g],h.new)h.new=!1;else{var k=this.mycallsclient_callLog.related.indexOf(h);-1<k&&(this.mycallsclient_callLog.related.splice(k,1),this.mycallsclient_callLog.pervWhatId==h._id&&(this.mycallsclient_callLog.pervWhatId=null),e=!0)}fjs.model.filter.SortRelatedFields()(this.mycallsclient_callLog.related);
if((f=f[this.phone])&&(i=this.findCallLogTargetById(f.id)))"who"==this.getRelatedItemType(i)?(this.mycallsclient_callLog.whoId=f.id,"Lead"!=i.object?(i=this.getWhat(),this.mycallsclient_callLog.whatId=i&&i._id):this.mycallsclient_callLog.whatId=null):(g=this.getWho(!0),this.mycallsclient_callLog.whoId=g&&g._id,this.mycallsclient_callLog.whatId=f.id);else if(g=this.findCallLogTargetById(this.mycallsclient_callLog.whoId),i=this.findCallLogTargetById(this.mycallsclient_callLog.whatId),g)!i&&"Lead"!=
g.object&&(i=this.getWhat(),this.mycallsclient_callLog.whatId=i&&i._id);else if(g=this.getWho(),this.mycallsclient_callLog.whoId=g&&g._id,!i&&(!g||"Lead"!=g.object))i=this.getWhat(),this.mycallsclient_callLog.whatId=i&&i._id;f&&b.deletePhone(this.phone);return e||d!=this.mycallsclient_callLog.whatId||c!=this.mycallsclient_callLog.whoId};
...
fjs.controllers.CallController=function(a,b,d,c,e,f,j){function g(b){if((m=a.call.phone)&&(!a.call.mycallsclient_callLog._notNew||b)&&a.call.type!=fjs.controllers.CallController.SYSTEM_CALL_TYPE){var c={action:"getPhoneInfo",data:{}};c.data.phone=a.call.getFormattedPhone();c.data.callType=a.call.incoming?"inbound":"outbound";c.data.isRinging=0==a.call.state;c.callback=function(c){a.call.fillCallLogData(c,t)&&(h(),l&&l.safeApply(a));b&&b(c)};q.sendAction(c)}}function h(){null!=o&&(clearTimeout(o),
o=null);o=setTimeout(function(){f.sendAction("mycallsclient","push",{callLog:a.call.mycallsclient_callLog,xpid:a.call.xpid})},fjs.controllers.CallController.CALL_LOG_CHANGE_DELAY_IN_SEC)}function i(){a.call.mycallsclient_callLog.isOpened=!0;a.call.mycallsclient_callLog.tranferOpened=!1;h()}fjs.controllers.CommonController(this);var k=null,n=new fjs.utils.TimeSync,m=null,l=this,o=null,q=j.getProvider(),t=f.getModel("clientsettings"),u=f.getModel("me"),v=f.getModel("locations");a.getTriangle=function(){return e.trustAsHtml(a.call.mycallsclient_callLog.isOpened?
...
(a.call.mycallsclient_callLog.pervWhatId=a.call.mycallsclient_callLog.whatId,a.call.mycallsclient_callLog.whatId=null):null==a.call.mycallsclient_callLog.whatId&&(a.call.mycallsclient_callLog.pervWhatId?a.call.mycallsclient_callLog.whatId=a.call.mycallsclient_callLog.pervWhatId:(b=a.call.getWhat(),a.call.mycallsclient_callLog.whatId=b&&b._id));h()};a.whatChange=function(){h()};a.noteChange=function(){h()};a.$watch("call.phone",function(b,c){b!=c&&(a.call.mycallsclient_callLog._notNew=!1);g()});a.hold=
function(){f.sendAction(fjs.model.MyCallsFeedModel.NAME,"transferToHold",{mycallId:a.call.xpid});return!1};a.accept=function(){f.sendAction(fjs.model.MyCallsFeedModel.NAME,"answer",{mycallId:a.call.xpid});return!1};a.transfer=function(){a.call.mycallsclient_callLog.tranferOpened?(a.call.mycallsclient_callLog.tranferOpened=!1,a.call.mycallsclient_callLog.isOpened=!0):(a.call.mycallsclient_callLog.tranferOpened=!0,a.call.mycallsclient_callLog.isOpened=!1);h()};a.end=function(){f.sendAction(fjs.model.MyCallsFeedModel.NAME,
"hangup",{mycallId:a.call.xpid});return!1};a.unhold=function(){f.sendAction(fjs.model.MyCallsFeedModel.NAME,"transferFromHold",{mycallId:a.call.xpid});return!1};a.toggleCallLog=function(){a.call.mycallsclient_callLog.isOpened?(a.call.mycallsclient_callLog.isOpened=!1,h()):i()};a.createContact=function(){(new SFApi).openCreateContactDialog(a.call.phone)};a.openSFLink=function(a){var b={action:"openUser",data:{}};b.data.id=a;q.sendAction(b)};a.closeTransferDialog=function(){i()};a.$on("transfer",function(b,
c){c&&f.sendAction(fjs.model.MyCallsFeedModel.NAME,"transferTo",{mycallId:a.call.xpid,toNumber:c});i()});var s=function(b){b=b||a;return b.showSaveCallLogDialog?b.showSaveCallLogDialog:s(b.$parent)};a.$on("$destroy",function(){k&&d.cancel(k);if(a.call.mycallsclient_callLog&&0<a.call.mycallsclient_callLog.related.length&&a.call.type!=fjs.controllers.CallController.SYSTEM_CALL_TYPE){if(a.call.type==fjs.controllers.CallController.QUEUE_CALL_TYPE&&a.call.state==fjs.controllers.CallController.RING_CALL_TYPE&&
...
n=k.clientHeight,m=null;document.body.onresize=function(){i()};setTimeout(function(){frame.onresize=function(){i()}},200);a.showBrowserWarning=function(){if(null===g){var a=!0;if(fjs.utils.Browser.isSafari())try{window.openDatabase("test","","test",1024)}catch(b){a=!1}g=!fjs.utils.Cookies.check()||!fjs.utils.LocalStorage.check()||!a}return g&&!j};a.getBrowserWarningLink=function(){return"http://www.fonality.com/crmlink/"+fjs.utils.Browser.getBrowserName()};a.getBrowserWarningMessage=function(){return"Click here for "+
...
a.mycallsclient_callLog.whoId;b.data.whatId=a.mycallsclient_callLog.whatId;b.data.note=a.mycallsclient_callLog.note;b.data.callType=a.incoming?"inbound":"outbound";b.data.duration=Math.round(((new Date).getTime()-(a.created+h.getDefault()))/1E3);b.data.date=a.mycallsclient_callLog.date;b.callback=function(a){fjs.utils.Console.error(a)};f.sendAction(b)}};a.$on("$destroy",function(){e.meModel.removeEventListener(fjs.controllers.CommonController.COMPLETE_LISTENER,e.meListener);d.removeWarningListener(fjs.controllers.CommonController.AUTHORIZATION_LISTENER,

...
fjs.model.MyCallsFeedModel.prototype.onSyncComplete=function(a){for(var b in this.changes)if(this.changes.hasOwnProperty(b)){var d=this.changes[b];if(d.push&&!d.delete){var c=d.push;(d=this.items[c.xpid])?d.fill(c.entry):(d=this.items[c.xpid]=new fjs.model.EntryModel(c.entry),this.order.push(d));this.prepareEntry(d);this.fireEvent("push",d);console.log("!!!!push ",c.xpid,c.entry)}else if(!d.push&&d.delete)c=d.delete,d=this.order.indexOf(this.items[c.xpid]),-1<d&&this.order.splice(d,1),delete this.items[c.xpid],
this.fireEvent("delete",c),console.log("!!!!delete ",c.xpid);else if(d.push&&d.delete){var c=d.delete,e=d.push,d=this.items[c.xpid];d.fill(e.entry);delete this.items[c.xpid];this.prepareEntry(d);this.items[e.xpid]=d;d.oldPid=c.xpid;e.eventType="changepid";this.fireEvent("changepid",d);console.log("!!!!changepid ","from:",d.oldPid,"to:",e.xpid)}}this.changes={};this.fireEvent("complete",a);console.log("!!!OnCallsSyncEnd!!!")};fjs.model.MyCallsFeedModel.NAME="mycallsclient";namespace("fjs.model");
fjs.model.DataManager=function(a){fjs.EventsSource.call(this);this.feeds={};this.node=this.ticket=null;this.phoneMap={};this.state=-1;this.suspendFeeds=[];this.warningListeners={};this.sf=a.getProvider();var b=this,d=new fjs.api.FDPProviderFactory;this.authErrorCount=0;this.MAX_AUTH_ERROR_COUNT=3;var c=function(a){var a=a&&a.result&&JSON.parse(a.result),c=a.number;if(c){var d={};d.id=a.objectId;d.type=a.object;b.phoneMap[c]=d;b.sendAction(fjs.model.MeModel.NAME,"callTo",{phoneNumber:c})}};this.checkDevice=
...
fjs.model.DataManager.prototype._getAuthInfo=function(a){this.sf.sendAction({action:"getLoginInfo",callback:function(b){var d=null,c=null;b&&(b.error?(console.error("SF response error",b.error),a(null)):c=JSON.parse(b.result));c&&(d={login:c.admLogin,token:c.admPassword,email:c.email},c.hudLogin&&(d.hud=c.hudLogin),fjs.fdp.CONFIG.SERVER.serverURL=c.serverUrl);a(d)}})};
...
fjs.controllers.CallController=function(a,b,d,c,e,f){function h(){var b=new Date,f=b.getTime()-D.getDefault()+6E4*(new Date(1)).getTimezoneOffset(),e=f-a.call.created,f=f-a.call.holdStart;a.duration=c("date")(new Date(e),"HH:mm:ss ");a.call.duration=b.getTime()-(a.call.created+D.getDefault());a.onHold&&(a.holdDuration=c("date")(new Date(f),"HH:mm:ss "));u=d(h,fjs.controllers.CallController.CALL_DURATION_DELAY_IN_SEC)}function n(b){var c={},d=null,f=0;o=[];g=[];m=p=null;q=[];if(b&&b.result){var b=
JSON.parse(b.result),h;for(h in b)if(b.hasOwnProperty(h)&&"screenPopUrl"!=h){f++;var k=d=b[h];c[k.object]||(c[k.object]=[]);k._id=h;"Contact"==k.object||"Lead"==k.object?g.push(k):("Case"==k.object&&(k.Name=k.CaseNumber),o.push(k));c[k.object].push(k)}if(1==f)for(var j in d)d.hasOwnProperty(j)&&"object"!=j&&"_id"!=j&&q.push({title:j,value:d[j],id:d._id});else for(j in c){f=c[j];f.sort(i);q.push({title:j+" ("+f.length+")",value:f[0][fjs.controllers.CallController.SORT_FIELD_NAME],id:f[0]._id});for(d=
1;d<f.length;d++)q.push({title:"",value:f[d][fjs.controllers.CallController.SORT_FIELD_NAME],id:f[d]._id})}}B();c=!1;if(p!=a.call.mycallsclient_callLog.whatId||m!=a.call.mycallsclient_callLog.whoId)c=!0;else if(j=0,a.call.mycallsclient_callLog.fields&&a.call.mycallsclient_callLog.fields.length!=q.length)c=!0;else if(a.call.mycallsclient_callLog.fields)for(j=0;j<a.call.mycallsclient_callLog.fields.length;j++){for(f=d=f=0;f<q.length;f++)q[f].id!=a.call.mycallsclient_callLog.fields[j].id&&d++;if(d==
q.length){c=!0;break}}else c=!0;c&&(a.call.mycallsclient_callLog.fields=q,a.call.mycallsclient_callLog.whatId=p,a.call.mycallsclient_callLog.whoId=m,a.call.mycallsclient_callLog.who=g,a.call.mycallsclient_callLog.what=o,e.sendAction("mycallsclient","push",{callLog:a.call.mycallsclient_callLog,xpid:a.call.xpid}));F.safeApply(a)}function l(){if(G=a.call.phone){var b=a.call.phone.replace(/\(|\)|-/g,"");10<b.length&&(b=b.slice(b.length-10,b.length));if(a.call.type!=fjs.controllers.CallController.SYSTEM_CALL_TYPE){var c=
{action:"getPhoneInfo",data:{}};c.data.phone=b;c.data.callType=a.call.incoming?"inbound":"outbound";c.data.isRinging=0==a.call.state;c.callback=n;v.sendAction(c)}else B(),e.sendAction("mycallsclient","push",{callLog:a.call.mycallsclient_callLog,xpid:a.call.xpid});w()}}function i(a,b){if(a[fjs.controllers.CallController.SORT_FIELD_NAME]&&a[fjs.controllers.CallController.SORT_FIELD_NAME]){var c=a[fjs.controllers.CallController.SORT_FIELD_NAME].toLowerCase(),d=b[fjs.controllers.CallController.SORT_FIELD_NAME].toLowerCase();
if(c<d)return-1;if(c>d)return 1}return 0}function B(){if(e.phoneMap[a.call.phone]){var b=e.phoneMap[a.call.phone];if("Contact"==b.type)m=b.id,t(0,o,p);else if("Lead"==b.type)m=b.id;else if(g){p=b.id;for(b=0;b<g.length;b++)if("Contact"==g[b].object){m=g[b]._id;break}}delete e.phoneMap[a.call.phone]}else if(!e.phoneMap[a.call.phone]&&!a.call.mycallsclient_callLog.whatId&&!a.call.mycallsclient_callLog.whoId)if(g&&g[0])m=g[0]._id,g[0]&&"Lead"==g[0].object||t(0);else{a:{if(null!=a.call.mycallsclient_callLog&&
null!=g&&null!=m)for(b=0;b<g.length;b++)if(g[b]._id==m){b=g[b]&&"Lead"==g[b].object;break a}b=void 0}b||t(0)}else if(a.call.mycallsclient_callLog&&a.call.mycallsclient_callLog.whoId&&g){for(var c=!1,b=0;b<g.length;b++)if(g[b]._id==a.call.mycallsclient_callLog.whoId){m=a.call.mycallsclient_callLog.whoId;p=a.call.mycallsclient_callLog.whatId;c=!0;break}c||a.call.mycallsclient_callLog.who&&g[0]&&(m=g[0]._id)}else if(a.call.mycallsclient_callLog&&p&&o){for(b=0;b<o.length&&o[b]._id!=p;b++);c||t(0)}}function t(a){null==
p&&(null!=o&&null!=o[a])&&(p=o[a]._id)}function C(){a.call.mycallsclient_callLog.isOpened=!1;a.call.mycallsclient_callLog.triangle=fjs.controllers.CallController.CLOSED_TRIANGLE;e.sendAction("mycallsclient","push",{callLog:a.call.mycallsclient_callLog,xpid:a.call.xpid})}function x(){a.call.mycallsclient_callLog.isOpened=!0;a.call.mycallsclient_callLog.triangle=fjs.controllers.CallController.OPENED_TRIANGLE;e.sendAction("mycallsclient","push",{callLog:a.call.mycallsclient_callLog,xpid:a.call.xpid})}
function y(){a.transferDialogPath=null;a.isTransferDialogClass=""}function z(){r&&(d.cancel(r),r=null)}function w(){r=d(l,fjs.controllers.CallController.CALL_GET_INFO_DELAY_IN_SEC)}fjs.controllers.CommonController(this);e.getModel("mycallsclient");var u=null,r=null,D=new fjs.utils.TimeSync,G=null,F=this,s=null,v=f.getProvider(),p,m,q=[],o=[],g=[];a.templatePath="templates/call_item.html";a.callLogPath="templates/call_log.html";a.transferDialogPath=null;a.onHold=a.call.state==fjs.controllers.CallController.HOLD_CALL_TYPE;
a.isRing=a.call.state==fjs.controllers.CallController.RING_CALL_TYPE;var A=new fjs.fdp.TabsSynchronizer,E=function(){A.isMaster?w():z()};A.addEventListener("master_changed",E);a.call.mycallsclient_callLog||(a.call.mycallsclient_callLog={},b=a.call.mycallsclient_callLog,f=new Date,f=f.getFullYear()+"-"+(f.getMonth()+1)+"-"+f.getDate(),b.date=f,a.call.mycallsclient_callLog.subject="Call",a.call.mycallsclient_callLog.xpid=a.call.xpid,a.call.mycallsclient_callLog.isOpened=!0,a.call.mycallsclient_callLog.note=
"",a.call.mycallsclient_callLog.callType=a.call.incoming?"inbound":"outbound",a.call.mycallsclient_callLog.triangle=fjs.controllers.CallController.OPENED_TRIANGLE);(void 0==a.call.mycallsclient_isOpened&&a.isRing||a.call.type==fjs.controllers.CallController.CONFERENCE_CALL_TYPE&&a.call.state==fjs.controllers.CallController.TALCKING_CALL_TYPE&&(a.call.mycallsclient_isOpened||void 0==a.call.mycallsclient_isOpened))&&a.$emit("selectCall",a.call);h();a.whoChange=function(){if(a.call.mycallsclient_callLog&&
a.call.mycallsclient_callLog.who){for(var b=0;b<a.call.mycallsclient_callLog.who.length;b++)if(a.call.mycallsclient_callLog.who[b]._id==a.call.mycallsclient_callLog.whoId){if(a.call.mycallsclient_callLog.who[b]&&a.call.mycallsclient_callLog.who[b].object=="Lead")a.call.mycallsclient_callLog.whatId=null;else if(a.call.mycallsclient_callLog.whatId==null&&a.call.mycallsclient_callLog.what!=null&&a.call.mycallsclient_callLog.what[0]!=null)a.call.mycallsclient_callLog.whatId=a.call.mycallsclient_callLog.what[0]._id;
break}e.sendAction("mycallsclient","push",{callLog:a.call.mycallsclient_callLog,xpid:a.call.xpid})}};a.whatChange=function(){e.sendAction("mycallsclient","push",{callLog:a.call.mycallsclient_callLog,xpid:a.call.xpid})};a.noteChange=function(){if(s!=null){clearTimeout(s);s=null}s=setTimeout(function(){e.sendAction("mycallsclient","push",{callLog:a.call.mycallsclient_callLog,xpid:a.call.xpid})},fjs.controllers.CallController.CALL_LOG_CHANGE_DELAY_IN_SEC)};a.$watch("call.state",function(){a.onHold=a.call.state==
fjs.controllers.CallController.HOLD_CALL_TYPE;if(!a.onHold){var b=(new Date(0)).getTime()+(new Date(0)).getTimezoneOffset()*6E4;a.holdDuration=c("date")(b,"HH:mm:ss ")}a.isRing=a.call.state==fjs.controllers.CallController.RING_CALL_TYPE},!0);a.$watch("call.phone",function(){l()});a.showDetails=function(){a.$emit("toggleCall",a.call)};a.hold=function(){e.sendAction(fjs.model.MyCallsFeedModel.NAME,"transferToHold",{mycallId:a.call.xpid});return false};a.accept=function(){e.sendAction(fjs.model.MyCallsFeedModel.NAME,
"answer",{mycallId:a.call.xpid});return false};a.transfer=function(){a.transferDialogPath="templates/transfer_dialog.html";a.isTransferDialogClass="call-item-transfer-opened";a.callLogPath&&C()};a.end=function(){e.sendAction(fjs.model.MyCallsFeedModel.NAME,"hangup",{mycallId:a.call.xpid});return false};a.unhold=function(){e.sendAction(fjs.model.MyCallsFeedModel.NAME,"transferFromHold",{mycallId:a.call.xpid});return false};a.toggleCallLog=function(){if(a.call.mycallsclient_callLog.isOpened)C();else{x();
y()}};a.openSFLink=function(a){var b={action:"openUser",data:{}};b.data.id=a;v.sendAction(b)};a.$on("closeDialog",function(){y();x()});a.$on("transfer",function(b,c){c&&c!=""&&e.sendAction(fjs.model.MyCallsFeedModel.NAME,"transferTo",{mycallId:a.call.xpid,toNumber:c});y();x()});a.$on("$destroy",function(){u&&d.cancel(u);A.removeEventListener("master_changed",E);z();if(a.call.mycallsclient_callLog&&a.call.type!=fjs.controllers.CallController.SYSTEM_CALL_TYPE){a.call.mycallsclient_callLog.subject=a.call.mycallsclient_callLog.note&&
a.call.mycallsclient_callLog.note!=""?"Call: "+a.call.mycallsclient_callLog.note.substr(0,240)+" ...":"Call";var b={action:"addCallLog",data:{}};b.data.subject=a.call.mycallsclient_callLog.subject;b.data.whoId=a.call.mycallsclient_callLog.whoId;b.data.whatId=a.call.mycallsclient_callLog.whatId;b.data.note=a.call.mycallsclient_callLog.note;b.data.callType=a.call.incoming?"inbound":"outbound";b.data.duration=Math.round(a.call.duration/1E3);b.data.date=a.call.mycallsclient_callLog.date;b.callback=function(a){console.error(a)};
v.sendAction(b)}clearTimeout(s)});a.$watch("call.mycallsclient_isOpened",function(){a.call.mycallsclient_isOpened?r||w():z()})};fjs.controllers.CallController.extend(fjs.controllers.CommonController);fjs.controllers.CallController.CONFERENCE_CALL_TYPE=0;fjs.controllers.CallController.SYSTEM_CALL_TYPE=7;fjs.controllers.CallController.HOLD_CALL_TYPE=3;fjs.controllers.CallController.RING_CALL_TYPE=0;fjs.controllers.CallController.TALCKING_CALL_TYPE=2;fjs.controllers.CallController.OPENED_TRIANGLE="&#9660;";
...
fjs.controllers.CallsListController=function(a,b){this.callsFeedModel=b.getModel("mycallsclient");var d=this;fjs.controllers.CommonController.call(this,a);a.calls=this.callsFeedModel.order;a.$on("toggleCall",function(a,b){b.mycallsclient_isOpened?c(b):e(b)});this.completeCallsListener=function(){d.safeApply(a)};this.callsFeedModel.addEventListener(fjs.controllers.CommonController.COMPLETE_LISTENER,this.completeCallsListener);a.$on("selectCall",function(a,b){e(b)});var c=function(a){if(a.mycallsclient_isOpened){var c=
{};a.mycallsclient_isOpened=c.isOpened=!1;c.xpid=a.xpid;c.xpid&&b.sendAction("mycallsclient","push",c)}},e=function(d){if(!d.mycallsclient_isOpened){var e={};d.mycallsclient_isOpened=e.isOpened=!0;e.xpid=d.xpid;e.xpid&&b.sendAction("mycallsclient","push",e)}d=d.xpid;for(e=0;e<a.calls.length;e++){var n=a.calls[e];n.xpid!=d&&n.mycallsclient_isOpened&&c(n)}}};fjs.controllers.CallsListController.extend(fjs.controllers.CommonController);fjs.controllers.CallsListController.SELECTED_CALL_ID="selected_call_id";
fjs.controllers.CallsListController.SELECTED_CALL_ID_MODE="selected_call_id_mode";namespace("fjs.controllers");
fjs.controllers.MainController=function(a,b,d){fjs.controllers.CommonController(this);var c=this,e=d.getProvider();this.clientSettingsModel=b.getModel(fjs.controllers.MainController.CLIENT_SETTINGS_FEED_MODEL);this.clientSettingsModel.addEventListener(fjs.controllers.CommonController.PUSH_LISTENER,function(b){if(b.xpid=fjs.controllers.MainController.IS_WARNING_SHOWN)a.isWarningsShown=b.value?!0:!1,c.safeApply(a)});this.meModel=b.getModel(fjs.model.MeModel.NAME);this.SOFTPHONE_HEIGHT=this.SOFTPHONE_WIDTH=
200;this.FRAME_RESIZE_NAME="resizeFrame";a.isConnected=!0;a.warningsTemplatePath="templates/warnings.html";a.isWarningsShown=!1;a.loggined=!0;a.connection=!0;a.phone=!0;a.isLocationRegistered=!0;var f=function(){null!=l&&(clearTimeout(l),l=null);l=setTimeout(function(){var a=h.clientHeight;if(a!=n){var b={action:"setSoftphoneHeight",data:{}};b.data.height=h.clientHeight;b.callback=function(){l=null};e.sendAction(b)}n=a},100)},d={action:"setSoftphoneHeight",data:{}};d.data.height=c.SOFTPHONE_HEIGHT;
e.sendAction(d);d={action:"setSoftphoneWidth",data:{}};d.data.height=c.SOFTPHONE_WIDTH;e.sendAction(d);var h=document.getElementById(c.FRAME_RESIZE_NAME),n=h.clientHeight,l=null;document.body.onresize=function(){f()};setTimeout(function(){frame.onresize=function(){f()}},200);a.showWarnings=function(){a.isWarningsShown=!0;c.safeApply(a);b.sendAction(fjs.controllers.MainController.CLIENT_SETTINGS_FEED_MODEL,"push",{xpid:fjs.controllers.MainController.IS_WARNING_SHOWN,value:a.isWarningsShown})};a.hideWarnings=
function(){a.isWarningsShown=!1;c.safeApply(a);b.sendAction(fjs.controllers.MainController.CLIENT_SETTINGS_FEED_MODEL,"push",{xpid:fjs.controllers.MainController.IS_WARNING_SHOWN,value:a.isWarningsShown})};a.toggleWarnings=function(){a.isWarningsShown?a.hideWarnings():a.showWarnings()};var i=function(){a.isWarningsButtonShown=!a.loggined||!a.connection||!a.isLocationRegistered;a.loggined&&(a.connection&&a.isLocationRegistered)&&(a.isWarningsShown=!1);c.safeApply(a)};this.meListener=function(){var b=
c.meModel.getProperty("display_name");a.name=b?"User: "+b:"";b=c.meModel.getProperty("primary_extension");a.extension=b?"Extension: x"+b:"";c.safeApply(a)};this.authorizationWarningListener=function(b){a.loggined=b;i();a.isConnected=a.connection&&a.loggined;c.safeApply(a)};this.connectionWarningListener=function(b){setTimeout(function(){a.connection=b;i();a.isConnected=a.connection&&a.loggined;c.safeApply(a)},1E3)};a.$on("onLocationStatus",function(b,d){a.isLocationRegistered=d;i();c.safeApply(a)});
a.$on("$destroy",function(){c.meModel.removeEventListener(fjs.controllers.CommonController.COMPLETE_LISTENER,c.meListener);b.removeWarningListener(fjs.controllers.CommonController.AUTHORIZATION_LISTENER,c.authorizationWarningListener);b.removeWarningListener(fjs.controllers.CommonController.CONNECTION_LISTENER,c.connectionWarningListener)});this.meModel.addEventListener(fjs.controllers.CommonController.COMPLETE_LISTENER,this.meListener);b.addWarningListener(fjs.controllers.MainController.AUTHORIZATION_LISTENER,

...
SFApi.prototype.addCallLog=function(a,b,c,d,e,f,j,h){var i="Completed";null==b&&null==c&&(i="Not Started");var g="Subject="+encodeURIComponent(a)+"&CallType="+e+"&CallDurationInSeconds="+f+"&Status="+i+"&Type=Call&ActivityDate="+j;b&&(g+="&WhoId="+b);c&&(g+="&WhatId="+c);SFApi.prototype.getCalllogCommentField(function(a){var b="Description";a&&a.result&&(null!=a.result&&""!=a.result)&&(b=a.result);d&&(g+="&"+b+"="+encodeURIComponent(d));f&&j&&e?sforce.interaction.saveLog("Task",g,function(a){h(a)}):
...
fjs.model.MyCallEntryModel.prototype.fillCallLogData=function(a,b){var c=this.mycallsclient_callLog.whatId,d=this.mycallsclient_callLog.whoId,e=!1;this.mycallsclient_callLog._notNew||(this.mycallsclient_callLog._notNew=e=!0);this.pidChanged&&(e=!0,this.pidChanged=!1);var f=b.items.phoneMap&&b.items.phoneMap.phones||{};if(a&&a.result){var j=fjs.utils.JSON.parse(a.result),h;for(h in j)if(j.hasOwnProperty(h)&&"screenPopUrl"!=h&&"CaseComment"!=j[h].object){var i=j[h];i._id=h;"Case"==i.object&&(i.Name=
...
h.object&&(g=this.getWhat(),this.mycallsclient_callLog.whatId=g&&g._id);else if(h=this.getWho(),this.mycallsclient_callLog.whoId=h&&h._id,!g&&(!h||"Lead"!=h.object))g=this.getWhat(),this.mycallsclient_callLog.whatId=g&&g._id;f&&b.deletePhone(this.phone);return e||c!=this.mycallsclient_callLog.whatId||d!=this.mycallsclient_callLog.whoId};
...
fjs.model.ClientSettingsFeedModel.prototype.deletePhone=function(a){this.items.phoneMap&&(delete this.items.phoneMap.phones[a],this.dataManager.sendAction("clientsettings","push",this.items.phoneMap))};namespace("fjs.model.filter");fjs.model.filter.What=function(){return function(a){return a.filter(function(a){return"Contact"!=a.object&&"Lead"!=a.object})}};namespace("fjs.model.filter");
fjs.model.filter.Who=function(){return function(a){return a.filter(function(a){return"Contact"==a.object||"Lead"==a.object})}};namespace("fjs.model.filter");fjs.model.filter.SortRelatedFields=function(){return function(a){a.sort(function(a,b){return a.object>b.object?1:a.object<b.object?-1:a.Name.toLowerCase()>b.Name.toLowerCase()?1:a.Name.toLowerCase()<b.Name.toLowerCase()?-1:0});var b=null,c=null,d=0;a.forEach(function(a){b!=a.object?(d=0,b=a.object,c=a):a.title="";d++;c.title=b+" ("+d+")"})}};
namespace("fjs.model.filter");fjs.model.filter.HasCallInfoFilter=function(){return function(a){return a.filter(function(a){return!!a.htCallId})}};namespace("fjs.model");
fjs.model.DataManager=function(a){fjs.EventsSource.call(this);this.feeds={};this.node=this.ticket=null;this.phoneMap={};this.state=-1;this.suspendFeeds=[];this.suspendActions=[];this.warningListeners={};this.loginInfo={};this.sf=a.getProvider();var b=this,c=new fjs.api.FDPProviderFactory;this.authErrorCount=0;this.MAX_AUTH_ERROR_COUNT=3;this.tabSynchronizer=new fjs.api.TabsSynchronizer;this.checkLoginTimeoutId=null;var d=function(a){var a=a&&a.result&&JSON.parse(a.result),d=a.number;if(d){var c={};
c.id=a.objectId;c.type=a.object;b.getModel("clientsettings").savePhone(d,c);b.sendAction(fjs.model.MeModel.NAME,"callTo",{phoneNumber:d})}};this.checkDevice=function(){var a={action:"setPhoneApi",data:{}};a.data.isReg=!0;a.callback=d;b.sf.sendAction(a)};this.checkDevice();var e=function(){null!=b.checkLoginTimeoutId&&clearInterval(b.checkLoginTimeoutId);b.checkLoginTimeoutId=setInterval(function(){b._getAuthInfo(function(a){a&&(b._authInfoChanged(a)&&b.dataProvider&&b.state)&&(fjs.utils.Cookies.remove(fjs.model.DataManager.AUTH_COOKIE_NAME),
...
fjs.controllers.CallController=function(a,b,c,d,e,f,j){function h(b){if((m=a.call.phone)&&(!a.call.mycallsclient_callLog._notNew||b)&&a.call.type!=fjs.controllers.CallController.SYSTEM_CALL_TYPE){var c={action:"getPhoneInfo",data:{}};c.data.phone=a.call.getFormattedPhone();c.data.callType=a.call.incoming?"inbound":"outbound";c.data.isRinging=0==a.call.state;c.callback=function(c){a.call.fillCallLogData(c,t)&&(i(),l&&l.safeApply(a));b&&b(c)};q.sendAction(c)}}function i(){null!=o&&(clearTimeout(o),
...
c){c&&f.sendAction(fjs.model.MyCallsFeedModel.NAME,"transferTo",{mycallId:a.call.xpid,toNumber:c});g()});var s=function(b){b=b||a;return b.showSaveCallLogDialog?b.showSaveCallLogDialog:s(b.$parent)};a.$on("$destroy",function(){k&&c.cancel(k);if(a.call.mycallsclient_callLog&&0<a.call.mycallsclient_callLog.related.length&&a.call.type!=fjs.controllers.CallController.SYSTEM_CALL_TYPE){if(a.call.type==fjs.controllers.CallController.QUEUE_CALL_TYPE&&a.call.state==fjs.controllers.CallController.RING_CALL_TYPE&&
...
null!=m&&(clearTimeout(m),m=null);m=setTimeout(function(){var c=k.clientHeight;if(c!=n){var d={action:"setSoftphoneHeight",data:{}};d.data.height=k.clientHeight;d.callback=function(){m=null};f.sendAction(d)}if(a.isIE()||a.isSafari())b[0].style.visibility="visible";n=c},100)},d={action:"setSoftphoneHeight",data:{}};d.data.height=e.SOFTPHONE_HEIGHT;f.sendAction(d);d={action:"setSoftphoneWidth",data:{}};d.data.width=e.SOFTPHONE_WIDTH;f.sendAction(d);var k=document.getElementById(e.FRAME_RESIZE_NAME),
...
a.mycallsclient_callLog.whoId;b.data.whatId=a.mycallsclient_callLog.whatId;b.data.note=a.mycallsclient_callLog.note;b.data.callType=a.incoming?"inbound":"outbound";b.data.duration=Math.round(((new Date).getTime()-(a.created+i.getDefault()))/1E3);b.data.date=a.mycallsclient_callLog.date;b.callback=function(a){fjs.utils.Console.error(a)};f.sendAction(b)}};a.$on("$destroy",function(){e.meModel.removeEventListener(fjs.controllers.CommonController.COMPLETE_LISTENER,e.meListener);c.removeWarningListener(fjs.controllers.CommonController.AUTHORIZATION_LISTENER,
e.authorizationWarningListener);c.removeWarningListener(fjs.controllers.CommonController.CONNECTION_LISTENER,e.connectionWarningListener)});this.meModel.addEventListener(fjs.controllers.CommonController.COMPLETE_LISTENER,this.meListener);c.addWarningListener(fjs.controllers.MainController.AUTHORIZATION_LISTENER,this.authorizationWarningListener);c.addWarningListener(fjs.controllers.MainController.CONNECTION_LISTENER,this.connectionWarningListener);l()};

...
namespace("fjs.model");fjs.model.MyCallEntryModel=function(a){var b=new Date(this.created);this.mycallsclient_callLog={date:b.getFullYear()+"-"+(b.getMonth()+1)+"-"+b.getDate(),subject:this.getCallSubject(),xpid:this.xpid,note:"",callType:this.incoming?"inbound":"outbound",isOpened:!0,tranferOpened:!1,whatId:null,whoId:null,related:[]};fjs.model.EntryModel.call(this,a)};fjs.model.MyCallEntryModel.extend(fjs.model.EntryModel);
...
fjs.model.MyCallEntryModel.prototype.getWho=function(a){for(var b=0;b<this.mycallsclient_callLog.related.length;b++){var c=this.mycallsclient_callLog.related[b];if("who"==this.getRelatedItemType(c)&&(!a||"Lead"!=c.object))return c}debugger};fjs.model.MyCallEntryModel.prototype.getWhat=function(){for(var a=0;a<this.mycallsclient_callLog.related.length;a++){var b=this.mycallsclient_callLog.related[a];if("what"==this.getRelatedItemType(b))return b}};
...
this.meModel=c.getModel(fjs.model.MeModel.NAME);this.SOFTPHONE_HEIGHT=this.SOFTPHONE_WIDTH=200;this.FRAME_RESIZE_NAME="resizeFrame";a.isConnected=!0;a.warningsTemplatePath="templates/warnings.html";a.isWarningsShown=!1;a.loggined=!0;a.connection=!0;a.phone=!0;a.isLocationRegistered=!0;a.fdpConfigured=!0;a.fdpErrorMessage="";a.dialogTemplate=null;a.dialogModel=null;var g=function(){var a=fjs.utils.Browser;if(h.clientHeight!=k&&(a.isIE()||a.isSafari()))b[0].style.visibility="hidden";null!=l&&(clearTimeout(l),
l=null);l=setTimeout(function(){var c=h.clientHeight;if(c!=k){var d={action:"setSoftphoneHeight",data:{}};d.data.height=h.clientHeight;d.callback=function(){l=null};f.sendAction(d)}if(a.isIE()||a.isSafari())b[0].style.visibility="visible";k=c},100)},d={action:"setSoftphoneHeight",data:{}};d.data.height=e.SOFTPHONE_HEIGHT;f.sendAction(d);d={action:"setSoftphoneWidth",data:{}};d.data.width=e.SOFTPHONE_WIDTH;f.sendAction(d);var h=document.getElementById(e.FRAME_RESIZE_NAME),k=h.clientHeight,l=null;document.body.onresize=
function(){g()};setTimeout(function(){frame.onresize=function(){g()}},200);a.showBrowserWarning=function(){if(null===i){var a=!0;if(fjs.utils.Browser.isSafari())try{window.openDatabase("test","","test",1024)}catch(b){a=!1}i=!fjs.utils.Cookies.check()||!fjs.utils.LocalStorage.check()||!a}return i&&!j};a.getBrowserWarningLink=function(){return"http://www.fonality.com/crmlink/"+fjs.utils.Browser.getBrowserName()};a.getBrowserWarningMessage=function(){return"Click here for "+fjs.utils.Browser.getBrowserName()+

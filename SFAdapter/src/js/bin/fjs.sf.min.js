...
fjs.controllers.CallController=function(a,b,d,c,e,f){function h(){var b=new Date,f=b.getTime()-D.getDefault()+6E4*(new Date(1)).getTimezoneOffset(),e=f-a.call.created,f=f-a.call.holdStart;a.duration=c("date")(new Date(e),"HH:mm:ss ");a.call.duration=b.getTime()-(a.call.created+D.getDefault());a.onHold&&(a.holdDuration=c("date")(new Date(f),"HH:mm:ss "));v=d(h,fjs.controllers.CallController.CALL_DURATION_DELAY_IN_SEC)}function n(b){var c={},d=null,f=0;o=[];g=[];m=p=null;q=[];if(b&&b.result){var b=
...
q.length){c=!0;break}}else c=!0;c&&(a.call.mycallsclient_callLog.fields=q,a.call.mycallsclient_callLog.whatId=p,a.call.mycallsclient_callLog.whoId=m,a.call.mycallsclient_callLog.who=g,a.call.mycallsclient_callLog.what=o,e.sendAction("mycallsclient","push",{callLog:a.call.mycallsclient_callLog,xpid:a.call.xpid}));F.safeApply(a)}function l(){u();if(G=a.call.phone){var b=a.call.phone.replace(/\(|\)|-/g,"");10<b.length&&(b=b.slice(b.length-10,b.length));if(a.call.type!=fjs.controllers.CallController.SYSTEM_CALL_TYPE){var c=
{action:"getPhoneInfo",data:{}};c.data.phone=b;c.data.callType=a.call.incoming?"inbound":"outbound";c.data.isRinging=0==a.call.state;c.callback=n;w.sendAction(c)}else B(),e.sendAction("mycallsclient","push",{callLog:a.call.mycallsclient_callLog,xpid:a.call.xpid});x()}}function i(a,b){if(a[fjs.controllers.CallController.SORT_FIELD_NAME]&&a[fjs.controllers.CallController.SORT_FIELD_NAME]){var c=a[fjs.controllers.CallController.SORT_FIELD_NAME].toLowerCase(),d=b[fjs.controllers.CallController.SORT_FIELD_NAME].toLowerCase();
...
z()}};a.openSFLink=function(a){var b={action:"openUser",data:{}};b.data.id=a;w.sendAction(b)};a.$on("closeDialog",function(){z();y()});a.$on("transfer",function(b,c){c&&c!=""&&e.sendAction(fjs.model.MyCallsFeedModel.NAME,"transferTo",{mycallId:a.call.xpid,toNumber:c});z();y()});a.$on("$destroy",function(){v&&d.cancel(v);A.removeEventListener("master_changed",E);u();if(a.call.mycallsclient_callLog&&a.call.type!=fjs.controllers.CallController.SYSTEM_CALL_TYPE){a.call.mycallsclient_callLog.subject=a.call.mycallsclient_callLog.note&&

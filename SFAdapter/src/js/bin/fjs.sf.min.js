...
SFApi.prototype.addCallLog=function(a,b,d,c,e,f,j,i){var h="Completed";null==b&&null==d&&(h="Not Started");var g="Subject="+encodeURIComponent(a)+"&CallType="+e+"&CallDurationInSeconds="+f+"&Status="+h+"&Type=Call&ActivityDate="+j;b&&(g+="&WhoId="+b);d&&(g+="&WhatId="+d);SFApi.prototype.getCalllogCommentField(function(a){var b="Description";a&&a.result&&(null!=a.result&&""!=a.result)&&(b=a.result);c&&(g+="&"+b+"="+encodeURIComponent(c));f&&j&&e?sforce.interaction.saveLog("Task",g,function(a){i(a)}):
...
fjs.model.MyCallEntryModel.prototype.fillCallLogData=function(a,b){var d=this.mycallsclient_callLog.whatId,c=this.mycallsclient_callLog.whoId,e=!1;this.mycallsclient_callLog._notNew||(this.mycallsclient_callLog._notNew=e=!0);this.pidChanged&&(e=!0,this.pidChanged=!1);var f=b.items.phoneMap&&b.items.phoneMap.phones||{};if(a&&a.result){var j=fjs.utils.JSON.parse(a.result),i;for(i in j)if(j.hasOwnProperty(i)&&"screenPopUrl"!=i&&"CaseComment"!=j[i].object){var h=j[i];h._id=i;"Case"==h.object&&(h.Name=
...
fjs.controllers.CallController=function(a,b,d,c,e,f,j){function i(b){if((m=a.call.phone)&&(!a.call.mycallsclient_callLog._notNew||b)&&a.call.type!=fjs.controllers.CallController.SYSTEM_CALL_TYPE){var c={action:"getPhoneInfo",data:{}};c.data.phone=a.call.getFormattedPhone();c.data.callType=a.call.incoming?"inbound":"outbound";c.data.isRinging=0==a.call.state;c.callback=function(c){a.call.fillCallLogData(c,t)&&(h(),l&&l.safeApply(a));b&&b(c)};q.sendAction(c)}}function h(){null!=o&&(clearTimeout(o),
...
(a.call.mycallsclient_callLog.pervWhatId=a.call.mycallsclient_callLog.whatId,a.call.mycallsclient_callLog.whatId=null):null==a.call.mycallsclient_callLog.whatId&&a.call.mycallsclient_callLog.pervWhatId&&(a.call.mycallsclient_callLog.whatId=a.call.mycallsclient_callLog.pervWhatId);h()};a.whatChange=function(){h()};a.noteChange=function(){h()};a.$watch("call.phone",function(b,c){b!=c&&(a.call.mycallsclient_callLog._notNew=!1);i()});a.hold=function(){f.sendAction(fjs.model.MyCallsFeedModel.NAME,"transferToHold",
{mycallId:a.call.xpid});return!1};a.accept=function(){f.sendAction(fjs.model.MyCallsFeedModel.NAME,"answer",{mycallId:a.call.xpid});return!1};a.transfer=function(){a.call.mycallsclient_callLog.tranferOpened?(a.call.mycallsclient_callLog.tranferOpened=!1,a.call.mycallsclient_callLog.isOpened=!0):(a.call.mycallsclient_callLog.tranferOpened=!0,a.call.mycallsclient_callLog.isOpened=!1);h()};a.end=function(){f.sendAction(fjs.model.MyCallsFeedModel.NAME,"hangup",{mycallId:a.call.xpid});return!1};a.unhold=
function(){f.sendAction(fjs.model.MyCallsFeedModel.NAME,"transferFromHold",{mycallId:a.call.xpid});return!1};a.toggleCallLog=function(){a.call.mycallsclient_callLog.isOpened?(a.call.mycallsclient_callLog.isOpened=!1,h()):g()};a.createContact=function(){(new SFApi).openCreateContactDialog(a.call.phone)};a.openSFLink=function(a){var b={action:"openUser",data:{}};b.data.id=a;q.sendAction(b)};a.closeTransferDialog=function(){g()};a.$on("transfer",function(b,c){c&&f.sendAction(fjs.model.MyCallsFeedModel.NAME,
"transferTo",{mycallId:a.call.xpid,toNumber:c});g()});var s=function(b){b=b||a;return b.showSaveCallLogDialog?b.showSaveCallLogDialog:s(b.$parent)};a.$on("$destroy",function(){k&&d.cancel(k);if(a.call.type!=fjs.controllers.CallController.SYSTEM_CALL_TYPE){var b=s();i(function(){b(a.call)})}l=null;clearTimeout(o)})};fjs.controllers.CallController.extend(fjs.controllers.CommonController);fjs.controllers.CallController.CONFERENCE_CALL_TYPE=0;fjs.controllers.CallController.SYSTEM_CALL_TYPE=7;
fjs.controllers.CallController.QUEUE_CALL_TYPE=3;fjs.controllers.CallController.HOLD_CALL_TYPE=3;fjs.controllers.CallController.RING_CALL_TYPE=0;fjs.controllers.CallController.TALCKING_CALL_TYPE=2;fjs.controllers.CallController.OPENED_TRIANGLE="&#9660;";fjs.controllers.CallController.CLOSED_TRIANGLE="&#9658;";fjs.controllers.CallController.SORT_FIELD_NAME="Name";fjs.controllers.CallController.CALL_GET_INFO_DELAY_IN_SEC=3E3;fjs.controllers.CallController.CALL_DURATION_DELAY_IN_SEC=1E3;
fjs.controllers.CallController.CALL_LOG_CHANGE_DELAY_IN_SEC=500;namespace("fjs.controllers");

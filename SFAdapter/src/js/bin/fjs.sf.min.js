...
(f=f[this.phone])&&(h=this.findCallLogTargetById(f.id))?"who"==this.getRelatedItemType(h)?(this.mycallsclient_callLog.whoId=f.id,"Lead"==h.object&&(this.mycallsclient_callLog.whatId=null)):(h=this.getWho(!0),this.mycallsclient_callLog.whoId=h&&h._id):(h=this.findCallLogTargetById(this.mycallsclient_callLog.whoId),h||(h=this.getWho(),this.mycallsclient_callLog.whoId=h&&h._id));f&&b.deletePhone(this.phone);return e||c!=this.mycallsclient_callLog.whatId||d!=this.mycallsclient_callLog.whoId};

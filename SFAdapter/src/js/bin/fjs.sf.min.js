...
{};a.mycallsclient_isOpened=c.isOpened=!1;c.xpid=a.xpid;c.callLog=a.mycallsclient_callLog;c.xpid&&b.sendAction("mycallsclient","push",c)}},e=function(d){if(!d.mycallsclient_isOpened){var e={};d.mycallsclient_isOpened=e.isOpened=!0;e.xpid=d.xpid;e.callLog=d.mycallsclient_callLog;e.xpid&&b.sendAction("mycallsclient","push",e)}d=d.xpid;for(e=0;e<a.calls.length;e++){var n=a.calls[e];n.xpid!=d&&n.mycallsclient_isOpened&&c(n)}}};fjs.controllers.CallsListController.extend(fjs.controllers.CommonController);

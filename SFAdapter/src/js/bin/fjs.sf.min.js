...
h()});a.callLogAvailable=function(){return""===a.call.phone||a.call.type==fjs.controllers.CallController.EXTERNAL_CALL};a.$on("$destroy",function(){k&&c.cancel(k);a.call.type==fjs.controllers.CallController.EXTERNAL_CALL?i(function(){f.sendAction("clientcalllog","push",{callLog:a.call.mycallsclient_callLog,incoming:a.call.incoming,created:a.call.created,ended:Date.now(),xpid:a.call.xpid})}):""===a.call.phone&&f.sendAction("clientcalllog","push",{callLog:a.call.mycallsclient_callLog,incoming:a.call.incoming,
created:a.call.created,ended:Date.now(),xpid:a.call.xpid});p=null;clearTimeout(o)})};fjs.controllers.CallController.extend(fjs.controllers.CommonController);fjs.controllers.CallController.CONFERENCE_CALL_TYPE=0;fjs.controllers.CallController.SYSTEM_CALL_TYPE=7;fjs.controllers.CallController.QUEUE_CALL_TYPE=3;fjs.controllers.CallController.EXTERNAL_CALL=5;fjs.controllers.CallController.HOLD_CALL_TYPE=3;fjs.controllers.CallController.RING_CALL_TYPE=0;
fjs.controllers.CallController.TALCKING_CALL_TYPE=2;fjs.controllers.CallController.OPENED_TRIANGLE="&#9660;";fjs.controllers.CallController.CLOSED_TRIANGLE="&#9658;";fjs.controllers.CallController.SORT_FIELD_NAME="Name";fjs.controllers.CallController.CALL_GET_INFO_DELAY_IN_SEC=3E3;fjs.controllers.CallController.CALL_DURATION_DELAY_IN_SEC=1E3;fjs.controllers.CallController.CALL_LOG_CHANGE_DELAY_IN_SEC=500;namespace("fjs.controllers");
...
a.log.callLog.note.length?confirm("Are you sure you want to cancel? If you click okay, all entered comments will be lost.")&&(a.log.callLog&&(a.log.callLog.note=""),a.saveCallLog()):a.saveCallLog()}};fjs.controllers.CallLogDialogController.extend(fjs.controllers.CommonController);namespace("fjs.controllers");

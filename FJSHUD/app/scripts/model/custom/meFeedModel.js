...
fjs.core.inherits(fjs.hud.MeFeedModel, fjs.hud.FeedModel);
...
fjs.hud.MeFeedModel.prototype.getMyAvatarUrl = function(width, height) {
    ...
    if(myPid) {
        return fjs.CONFIG.SERVER.serverURL+"/v1/contact_image?pid="+myPid+"&w="+width+"&h="+height+"&Authorization=" + this.dataManager.api.ticket+"&node="+this.dataManager.api.node;
    }
    else {

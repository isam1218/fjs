...
fjs.hud.GroupEntryModel = function(obj, groupFeed) {
    fjs.hud.EntryModel.call(this, obj, 'groups');
    this.memberIds = [];
    /**
     * @type {GroupFeedModel}
     */
...
fjs.core.inherits(fjs.hud.GroupEntryModel, fjs.hud.EntryModel);
...
fjs.hud.GroupEntryModel.prototype.getServerName = function() {
    ...
    var serverEntry = this.dataManager.getModel("server").getEntryByXpid(this["serverNumber"]);
...
fjs.hud.GroupEntryModel.prototype.getAvatar = function(index, width, height) {
    if(this.memberIds.length > index){
        var /**@type {fjs.hud.ContactEntryModel}*/ contact = this.contactsModel.getEntryByXpid(this.memberIds[index]);
...
//        var contact = this.contactsModel.getEntryByXpid(this.memberIds[i]);
...
fjs.hud.GroupEntryModel.prototype.getOwnerName = function(){
    ...
    var _owner = this.contactsModel.getEntryByXpid(this.ownerId);

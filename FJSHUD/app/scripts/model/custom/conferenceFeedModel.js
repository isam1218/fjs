...
fjs.hud.ConferenceFeedModel = function(dataManager) {
    ...
    var context = this;
    this.conferenceMembersModel.addEventListener("push", function(data){
        context.pushConferenceMember(data);
    });
    this.conferenceMembersModel.addEventListener("delete", function(data){
        context.deleteConferenceMember(data);
    });
};

fjs.core.inherits(fjs.hud.ConferenceFeedModel, fjs.hud.FeedModel);
...
fjs.hud.ConferenceFeedModel.prototype.onEntryChange = function(data) {
    ...
    fjs.hud.ConferenceFeedModel.super_.prototype.onEntryChange.call(this, data);
    if(isNew){

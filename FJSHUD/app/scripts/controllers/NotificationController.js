hudweb.controller('NotificationController', ['$scope', '$rootScope', 'HttpService','NotificationsService', '$routeParams', '$location','PhoneService','ContactService','QueueService','SettingsService','ConferenceService','$timeout','NtpService', 
  function($scope, $rootScope, myHttpService, globals, $routeParam, $location, phoneService, contactService, queueService, settingsService, conferenceService, $timeout, ntpService){

  var playChatNotification = false;
  var displayDesktopAlert = true;
  $scope.notifications = globals.notifications  || [];
  $scope.calls = [];

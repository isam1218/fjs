...
fjs.ui.VoicemailTab = function($scope, $routeParams, dataManager, filterVoicemailFn) {
    ...
    this.voicemailModel.addEventListener("complete", $scope.$safeApply);
    $scope.voicemails = this.voicemailModel.items;
    $scope.query = "";
...
//        return false;
    ...
    $scope.$on("$destroy", function() {
        context.voicemailModel.removeEventListener("complete", $scope.$safeApply);
    });


};
fjs.core.inherits(fjs.ui.VoicemailTab, fjs.ui.SortableController)
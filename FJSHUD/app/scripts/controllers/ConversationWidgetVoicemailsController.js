...
fjs.ui.ConversationWidgetVoicemailsController = function($scope, $routeParams, $timeout, $filter, dataManager) {
    ...
    $scope.voicemailsModel = dataManager.getModel("voicemailbox");

    $scope.voicemails = $scope.voicemailsModel.items;

...
　　　　all_my_calls:	'All my calls (recommended)',
       ...
       current_call:'Current Call',
		interface_word:'Interface Settings',
       ...
       web_launcher_on_hang_ups:'Launch the web page below after call hangs up',
...
　　　　     all_my_calls:	'全ての通話を表示する',
      ...
      Message:'セキュリティ',
      message_individual:'このチャットメッセージは個別に各チームメンバーに送信されます。',
      Security:'セキュリティ',
      visible_to_entire:'会社全体に表示されます',
      job_is_done:'ジョブが実行されました。?',
      click_to_delete:'このチームを削除して、さよならを言うために、ここをクリックしてください。',
      create_team:'チームを作成',
      send_message:'Send Message',
      delete_group:'Delete Group',
      delete_word:'Delete',
      ...
      items:'アイテム',
      items_found:'アイテムが見つかりました。',
      download_current:'現在のダウンロード',
      attachments:'添付',
      attach:'添付する',
      attach_files_to_share:'共有するためにファイルを添付',
      schedule_move_to_trash:'ゴミ箱に移動するスケジュール',
      auto_delete:'自動削除',
      file:'File',
      bytes:'bytes',
      Preview:'プレビュー：',
      Previous:'前',
      Next:'次の',
      share_message_and_files:'共有メッセージ·ファイル',
      time_to_goodbye:'さよならを言う時間...',
      expand_team:'チームを展開',
      build_team:'チームを作る',
      in_queue:'In Queue',
      calls_in_queue_longest_wait:'call(s) in queue with the longest wait time of',
      ...
      contacts_barge_call:'Contacts who barge the call',
      call_transfer:'転送',
      contact_to_transfer:'転送するために接触',
      transfer_selected_person:'この人は、選択された宛先に転送されます',
      ...
      are_you_ready:'Are you Ready',
      call_transfer_to_conference:'Call will be transferred to this conference',
      contacts_will_be_transfered_to_conference:'これらの接点は、会議室に転送されます',
      Options:'Options',
      add_yourself_to_conference:'Add yourself to the conference',
      join_me_as_well:'Join me as well',

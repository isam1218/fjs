...
(this.db=(new fjs.db.DBFactory).getDB(),setInterval(function(){for(var a in d.lastValues){var b=d.lastValues[a];1==d.db.state&&function(b){d.db.selectByIndex("tabsync",{eventType:a},function(){},function(a){if(a){a.sort(function(a,b){return a.order>b.order?1:a.order<b.order?-1:0});for(var c=0;c<a.length;c++){var e=a[c],f=e.key,g=f.split("|");0>b.indexOf(f)&&g[1]!=d.tabId&&(console.log("read",f),d.fireEvent(e.eventType,{key:e.eventType,newValue:e.val}),b.push(f),function(a){setTimeout(function(){var c=
b.indexOf(a);0<=c&&b.splice(c,1)},1E4)}(f))}}})}(b)}},1E3)));this.superClass.addEventListener.call(this,a,b)};fjs.api.TabsSynchronizer.prototype.removeEventListener=function(a,b){if(fjs.utils.Browser.isIE11()){var d=this.lastValues[a].indexOf(b);-1<d&&this.lastValues[a].splice(d,1);this.lastValues[a].length=0}this.superClass.removeEventListener.call(this,a,b)};fjs.api.TabsSynchronizer.prototype.generateDataKey=function(a){var b=new fjs.utils.Increment;return a+"|"+this.tabId+"|"+b.get("tabsyncKeys")};
fjs.api.TabsSynchronizer.prototype.setSyncValue=function(a,b){if(this.db&&1==this.db.state){var d=this.generateDataKey(a),c=this,e=new fjs.utils.Increment;console.log("write",d);c.db.insertOne("tabsync",{key:d,eventType:a,val:b,order:Date.now()+""+e.get("tabsSync")},function(){setTimeout(function(){c.db.deleteByKey("tabsync",d)},5E3)})}}})();

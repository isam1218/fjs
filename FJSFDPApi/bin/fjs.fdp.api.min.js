...
!1;this._runMaster=function(){a._masterIteration()};this.db=null;this._masterIteration=function(){fjs.utils.Browser.isIE11()?fjs.utils.Cookies.set(a.TABS_SYNCRONIZE_KEY,a.tabId+"|"+Date.now()):localStorage.setItem(a.TABS_SYNCRONIZE_KEY,a.tabId+"|"+Date.now());a.isMaster||a.fireEvent("master_changed",a.isMaster=!0);clearTimeout(a.timeoutId);a.timeoutId=setTimeout(a._masterIteration,a.MASTER_ACTIVITY_TIMEOUT)};fjs.utils.Browser.isIE11()?setInterval(function(){var b=fjs.utils.Cookies.get(a.TABS_SYNCRONIZE_KEY);
b&&b!=a.lastMasterValue&&(a.onStorage({key:a.TABS_SYNCRONIZE_KEY,newValue:b}),a.lastMasterValue=b)},0):self.addEventListener("storage",a.onStorage,!1);this.onStorage=function(b){b.key==a.TABS_SYNCRONIZE_KEY&&(b=b.newValue.split("|"),b[0]!=a.tabId&&a.tabId>b[0]&&(a.isMaster&&a.fireEvent("master_changed",a.isMaster=!1),clearTimeout(a.timeoutId),a.timeoutId=setTimeout(a._runMaster,a.CHANGE_TAB_TIMEOUT)))};this._checkMaster()?this._runMaster():this.timeoutId=setTimeout(this._runMaster,this.CHANGE_TAB_TIMEOUT)};
fjs.api.TabsSynchronizer.extend(fjs.EventsSource);fjs.api.TabsSynchronizer.prototype._checkMaster=function(){var a;a=fjs.utils.Browser.isIE11()?fjs.utils.Cookies.get(this.TABS_SYNCRONIZE_KEY):localStorage.getItem(this.TABS_SYNCRONIZE_KEY);return!a||Date.now()-parseInt(a.split("|")[1])>this.CHANGE_TAB_TIMEOUT};fjs.api.TabsSynchronizer.prototype.addEventListener=function(a,b){var d=this;"master_changed"!=a&&(this.lastValues[a]||(this.lastValues[a]=[]),this.cookiesSynchronizationRuned||(this.db=(new fjs.db.DBFactory).getDB(),
setInterval(function(){for(var a in d.lastValues){var b=d.lastValues[a];1==d.db.state&&function(b){d.db.selectByIndex("tabsync",{eventType:a},function(){},function(a){if(a){a.sort(function(a,b){return a.order>b.order?1:a.order<b.order?-1:0});for(var c=0;c<a.length;c++){var e=a[c],f=e.key,g=f.split("|");0>b.indexOf(f)&&g[1]!=d.tabId&&(d.fireEvent(e.eventType,{key:e.eventType,newValue:e.val}),b.push(f),function(a){setTimeout(function(){var c=b.indexOf(a);0<=c&&b.splice(c,1)},1E4)}(f))}}})}(b)}},1E3)));
this.superClass.addEventListener.call(this,a,b)};fjs.api.TabsSynchronizer.prototype.removeEventListener=function(a,b){delete this.lastValues[a];this.superClass.removeEventListener.call(this,a,b)};fjs.api.TabsSynchronizer.prototype.generateDataKey=function(a){var b=new fjs.utils.Increment;return a+"|"+this.tabId+"|"+b.get("tabsyncKeys")};fjs.api.TabsSynchronizer.prototype.setSyncValue=function(a,b){if(this.db&&1==this.db.state){var d=this.generateDataKey(a),c=this,e=new fjs.utils.Increment;this.db.insertOne("tabsync",
{key:d,eventType:a,val:b,order:Date.now()+""+e});setTimeout(function(a){c.db.deleteByKey("tabsync",a)},1E4)}}})();

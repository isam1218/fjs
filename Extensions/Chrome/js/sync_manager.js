...
(function(){
    ...
    /**
     * SyncManager
     * @param {IndexedDBProvider} dbProvider
     * @constructor
     */
    var sm = fjs.fdp.SyncManager = function(dbProvider) {
        //Singleton
     ...
     * @param {*} ajaxProvider
     */
    fjs.fdp.SyncManager.prototype.init = function(ticket, node, serverUrl, ajaxProvider, authHandler) {
        var context = this;
    ...
    fjs.fdp.SyncManager.prototype.requestVersionscache = function() {
        var data = {"path":location.origin, "no_image":"img/Generic-Avatar-Small.png" }, context = this;
    ...
    fjs.fdp.SyncManager.prototype.requestClientRegistry = function(callback) {
        ...
        this.sendRequest(url, {"path":location.origin, "no_image":"img/Generic-Avatar-Small.png"}, function(xhr, data, isOk) {
            if(isOk) {
